...
Void FlxNapeSprite_obj::addPremadeBody( ::nape::phys::Body NewBody){
{
			...
			HX_STACK_LINE(139)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/nape/FlxNapeSprite.hx",139,0x811bdfdd)
						{
							HX_STACK_LINE(139)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(139)
		...
		HX_STACK_LINE(140)
		{
			...
			HX_STACK_LINE(140)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/nape/FlxNapeSprite.hx",140,0x811bdfdd)
						{
							HX_STACK_LINE(140)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(140)
		...
		HX_STACK_LINE(141)
		{
			...
			{
				HX_STACK_LINE(141)
				if (((NewBody->zpp_inner->compound != null()))){
					HX_STACK_LINE(141)
					HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot set the space of a Body belonging to a Compound, only the root Compound space can be set"));
				}
				HX_STACK_LINE(141)
	...
	HX_STACK_ARG(_Type,"_Type")
{
		...
		HX_STACK_LINE(163)
		::nape::phys::BodyType _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(163)
		if (((_Type != null()))){
			HX_STACK_LINE(163)
			_g = _Type;
			...
			HX_STACK_LINE(163)
			_g = ::zpp_nape::util::ZPP_Flags_obj::BodyType_DYNAMIC;
		}
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::flixel::addons::nape::FlxNapeSprite_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/nape/FlxNapeSprite.hx",163,0x811bdfdd)
				{
					...
					HX_STACK_LINE(163)
					return _Function_2_1::Block(x,y);
				}
				return null();
			}
		};
		HX_STACK_LINE(163)
		this->body = ::nape::phys::Body_obj::__new(_g,_Function_1_1::Block(this));
		HX_STACK_LINE(164)
		{
			HX_STACK_LINE(164)
	...
	HX_STACK_ARG(_Type,"_Type")
{
		...
		HX_STACK_LINE(201)
		{
			...
			::nape::shape::ShapeList _this = this->body->zpp_inner->wrap_shapes;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(201)
			::nape::shape::Shape obj = ::nape::shape::Polygon_obj::__new(::nape::shape::Polygon_obj::box(Width,Height,null()),null(),null());		HX_STACK_VAR(obj,"obj");
			HX_STACK_LINE(201)
			if ((_this->zpp_inner->reverse_flag)){
				HX_STACK_LINE(201)
				_this->push(obj);
	...
	HX_STACK_ARG(RotationFriction,"RotationFriction")
{
		...
		HX_STACK_LINE(223)
		this->body->setShapeMaterials(::nape::phys::Material_obj::__new(Elasticity,DynamicFriction,StaticFriction,Density,RotationFriction));
	}
return null();
}
...
Void FlxNapeSprite_obj::updatePhysObjects( ){
{
		...
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static Float Block( ::flixel::addons::nape::FlxNapeSprite_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/nape/FlxNapeSprite.hx",271,0x811bdfdd)
				{
					HX_STACK_LINE(271)
					::nape::geom::Vec2 _this;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(271)
		...
		HX_STACK_LINE(271)
		this->set_x((_Function_1_1::Block(this) - this->origin->x));
		struct _Function_1_2{
			inline static Float Block( ::flixel::addons::nape::FlxNapeSprite_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/nape/FlxNapeSprite.hx",272,0x811bdfdd)
				{
					HX_STACK_LINE(272)
					::nape::geom::Vec2 _this;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(272)
		...
		HX_STACK_LINE(272)
		this->set_y((_Function_1_2::Block(this) - this->origin->y));
		HX_STACK_LINE(274)
		if ((!(this->body->zpp_inner->norotate))){
			HX_STACK_LINE(276)
			this->set_angle((this->body->zpp_inner->rot * ::flixel::util::FlxAngle_obj::TO_DEG));
		}
		HX_STACK_LINE(280)
		if (((bool((this->_linearDrag < (int)1)) || bool((this->_angularDrag < (int)1))))){
			...
			{
				HX_STACK_LINE(282)
				::nape::phys::Body _g = this->body;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(282)
				{
					HX_STACK_LINE(282)
					Float angularVel = (_g->zpp_inner->angvel * this->_angularDrag);		HX_STACK_VAR(angularVel,"angularVel");
					HX_STACK_LINE(282)
					{
						HX_STACK_LINE(282)
						...
						HX_STACK_LINE(282)
						if (((_g->zpp_inner->angvel != angularVel))){
							HX_STACK_LINE(282)
							...
							HX_STACK_LINE(282)
							if (((_g->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_STATIC))){
								HX_STACK_LINE(282)
				...
				HX_STACK_LINE(283)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec2 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/nape/FlxNapeSprite.hx",283,0x811bdfdd)
							{
								HX_STACK_LINE(283)
					...
					HX_STACK_LINE(283)
					x = (_Function_4_1::Block(_g) * this->_linearDrag);
					HX_STACK_LINE(283)
					{
						HX_STACK_LINE(283)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
			...
			HX_STACK_LINE(284)
			{
				...
				HX_STACK_LINE(284)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec2 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/addons/nape/FlxNapeSprite.hx",284,0x811bdfdd)
							{
								HX_STACK_LINE(284)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(284)
					...
					HX_STACK_LINE(284)
					y = (_Function_4_1::Block(_g) * this->_linearDrag);
					HX_STACK_LINE(284)
					{
						HX_STACK_LINE(284)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
