...
Void ZPP_Debug_obj::xform_invalidate( ){
{
			...
			HX_STACK_LINE(251)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &q){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/util/Debug.hx",251,0xeecbde16)
						{
							HX_STACK_LINE(251)
							if (((bool((q != null())) && bool(q->zpp_disp)))){
								HX_STACK_LINE(251)
		...
		HX_STACK_LINE(255)
		{
			...
			HX_STACK_LINE(255)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &q){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/util/Debug.hx",255,0xeecbde16)
						{
							HX_STACK_LINE(255)
							if (((bool((q != null())) && bool(q->zpp_disp)))){
								HX_STACK_LINE(255)
		...
		HX_STACK_LINE(259)
		{
			HX_STACK_LINE(259)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &q){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/util/Debug.hx",259,0xeecbde16)
						{
							HX_STACK_LINE(259)
							if (((bool((q != null())) && bool(q->zpp_disp)))){
								HX_STACK_LINE(259)
