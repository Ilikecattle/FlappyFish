...
bool ZPP_Set_ZPP_SimpleSeg_obj::has( ::zpp_nape::geom::ZPP_SimpleSeg obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleSeg","has",0x4e9e1d1d,"zpp_nape.util.ZPP_Set_ZPP_SimpleSeg.has","zpp_nape/util/RBTree.hx",4765,0x3f078845)
	HX_STACK_THIS(this)
...
bool ZPP_Set_ZPP_SimpleSeg_obj::has_weak( ::zpp_nape::geom::ZPP_SimpleSeg obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleSeg","has_weak",0xe878b21a,"zpp_nape.util.ZPP_Set_ZPP_SimpleSeg.has_weak","zpp_nape/util/RBTree.hx",4776,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(4776)
