...
bool ZPP_Set_ZPP_PartitionVertex_obj::has( ::zpp_nape::geom::ZPP_PartitionVertex obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionVertex","has",0xa7a20788,"zpp_nape.util.ZPP_Set_ZPP_PartitionVertex.has","zpp_nape/util/RBTree.hx",2987,0x3f078845)
	HX_STACK_THIS(this)
...
bool ZPP_Set_ZPP_PartitionVertex_obj::has_weak( ::zpp_nape::geom::ZPP_PartitionVertex obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_PartitionVertex","has_weak",0x4f3423cf,"zpp_nape.util.ZPP_Set_ZPP_PartitionVertex.has_weak","zpp_nape/util/RBTree.hx",2998,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(2998)
