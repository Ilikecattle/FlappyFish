...
bool ZPP_Set_ZPP_SimpleEvent_obj::has( ::zpp_nape::geom::ZPP_SimpleEvent obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleEvent","has",0x16186f22,"zpp_nape.util.ZPP_Set_ZPP_SimpleEvent.has","zpp_nape/util/RBTree.hx",5654,0x3f078845)
	HX_STACK_THIS(this)
...
bool ZPP_Set_ZPP_SimpleEvent_obj::has_weak( ::zpp_nape::geom::ZPP_SimpleEvent obj){
	HX_STACK_FRAME("zpp_nape.util.ZPP_Set_ZPP_SimpleEvent","has_weak",0x0a1dedf5,"zpp_nape.util.ZPP_Set_ZPP_SimpleEvent.has_weak","zpp_nape/util/RBTree.hx",5665,0x3f078845)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(5665)
