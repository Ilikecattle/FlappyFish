...
{
		HX_STACK_FRAME("zpp_nape.phys.ZPP_FluidProperties","feature_cons",0xf0fe182b,"zpp_nape.phys.ZPP_FluidProperties.feature_cons","zpp_nape/phys/FluidProperties.hx",239,0x45ff3bfc)
		HX_STACK_THIS(this)
		HX_STACK_LINE(239)
		this->shapes = ::zpp_nape::util::ZNPList_ZPP_Shape_obj::__new();
	}
