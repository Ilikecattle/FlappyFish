		...
		if (((((this->velx * this->velx) + (this->vely * this->vely)) > linSq))){
			...
			struct _Function_3_1{
				inline static Float Block( ::zpp_nape::phys::ZPP_Body_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/phys/Body.hx",311,0x4bb115c1)
					{
						HX_STACK_LINE(311)
...
::nape::phys::Body ZPP_Body_obj::__static( ){
	...
	struct _Function_1_1{
		inline static ::nape::phys::BodyType Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/phys/Body.hx",1377,0x4bb115c1)
			{
				HX_STACK_LINE(1377)
	...
	inline static Array< ::Dynamic > Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/phys/Body.hx",193,0x4bb115c1)
		{
			...
			HX_STACK_LINE(193)
			{
				...
				HX_STACK_LINE(193)
				_g = ::zpp_nape::util::ZPP_Flags_obj::BodyType_STATIC;
			}
			HX_STACK_LINE(193)
			...
			HX_STACK_LINE(193)
			return Array_obj< ::Dynamic >::__new().Add(null()).Add(_g).Add(_g1).Add(_Function_1_1::Block());
		}
		return null();
	}
};
