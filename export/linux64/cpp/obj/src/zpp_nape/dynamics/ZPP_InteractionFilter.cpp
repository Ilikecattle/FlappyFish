...
{
		HX_STACK_FRAME("zpp_nape.dynamics.ZPP_InteractionFilter","feature_cons",0x8cbd03fc,"zpp_nape.dynamics.ZPP_InteractionFilter.feature_cons","zpp_nape/dynamics/InteractionFilter.hx",239,0x8f5b39cd)
		HX_STACK_THIS(this)
		HX_STACK_LINE(239)
		this->shapes = ::zpp_nape::util::ZNPList_ZPP_Shape_obj::__new();
	}
