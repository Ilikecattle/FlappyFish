...
struct _Function_0_1{
	inline static Array< ::Dynamic > Block( ){
		...
		{
			HX_STACK_LINE(264)
			::nape::dynamics::ArbiterType _g;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(264)
			{
				HX_STACK_LINE(264)
				...
				HX_STACK_LINE(264)
				_g = ::zpp_nape::util::ZPP_Flags_obj::ArbiterType_COLLISION;
			}
			HX_STACK_LINE(264)
			...
			HX_STACK_LINE(264)
			{
				...
				HX_STACK_LINE(264)
				_g1 = ::zpp_nape::util::ZPP_Flags_obj::ArbiterType_SENSOR;
			}
			...
			HX_STACK_LINE(264)
			return Array_obj< ::Dynamic >::__new().Add(null()).Add(_g).Add(_g1).Add(null()).Add(_Function_1_1::Block());
		}
		return null();
	}
};
