		...
		if ((this->is_sweep)){
			...
			if ((!(node->synced))){
				...
				if (((shape->body->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_STATIC))){
					...
					HX_STACK_LINE(189)
					_g = !(shape->body->component->sleeping);
				}
				...
				HX_STACK_LINE(189)
				bool sync = (bool((node->dyn != _g)) || bool(!(_Function_3_1::Block(shape,node))));		HX_STACK_VAR(sync,"sync");
				HX_STACK_LINE(189)
				if ((sync)){
					HX_STACK_LINE(189)
					node->synced = true;
		...
		if (((this->aabbShape == null()))){
			struct _Function_2_1{
				inline static ::nape::phys::BodyType Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/Broadphase.hx",212,0xcf31b77a)
					{
						HX_STACK_LINE(212)
...
Void ZPP_Broadphase_obj::updateCircShape( Float x,Float y,Float r){
{
		...
		if (((this->circShape == null()))){
			struct _Function_2_1{
				inline static ::nape::phys::BodyType Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/space/Broadphase.hx",239,0xcf31b77a)
					{
						HX_STACK_LINE(239)
						if (((::zpp_nape::util::ZPP_Flags_obj::BodyType_STATIC == null()))){
							HX_STACK_LINE(239)
