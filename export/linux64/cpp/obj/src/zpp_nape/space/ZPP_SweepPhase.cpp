	...
	if (((ray->dirx == (int)0))){
		...
		while(((bool((a != null())) && bool((a->aabb->minx <= rayab->minx))))){
			...
			HX_STACK_LINE(666)
			{
				...
				::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(666)
				_g = (bool((bool((bool((rayab->miny <= _this->maxy)) && bool((_this->miny <= rayab->maxy)))) && bool((rayab->minx <= _this->maxx)))) && bool((_this->minx <= rayab->maxx)));
			}
			struct _Function_3_1{
			...
			HX_STACK_LINE(666)
			if (((bool(_g) && bool(((bool((filter == null())) || bool(_Function_3_1::Block(filter,a)))))))){
				HX_STACK_LINE(667)
		...
		if (((ray->dirx < (int)0))){
			...
			while(((a != null()))){
				...
				HX_STACK_LINE(691)
				{
					...
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(691)
					_g1 = (bool((bool((bool((rayab->miny <= _this->maxy)) && bool((_this->miny <= rayab->maxy)))) && bool((rayab->minx <= _this->maxx)))) && bool((_this->minx <= rayab->maxx)));
				}
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::space::ZPP_SweepData &a){
				...
				HX_STACK_LINE(691)
				if (((bool(_g1) && bool(((bool((filter == null())) || bool(_Function_4_1::Block(filter,a)))))))){
					HX_STACK_LINE(692)
					Float t = ray->aabbsect(a->aabb);		HX_STACK_VAR(t,"t");
					HX_STACK_LINE(693)
					if (((bool((t >= (int)0)) && bool((t < mint))))){
			...
			while(((bool((bool((a != null())) && bool((a->aabb->minx <= rayab->maxx)))) && bool((a->aabb->minx < (ray->originx + (ray->dirx * mint))))))){
				...
				HX_STACK_LINE(710)
				{
					...
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(710)
					_g2 = (bool((bool((bool((rayab->miny <= _this->maxy)) && bool((_this->miny <= rayab->maxy)))) && bool((rayab->minx <= _this->maxx)))) && bool((_this->minx <= rayab->maxx)));
				}
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::dynamics::ZPP_InteractionFilter &filter,::zpp_nape::space::ZPP_SweepData &a){
				...
				HX_STACK_LINE(710)
				if (((bool(_g2) && bool(((bool((filter == null())) || bool(_Function_4_1::Block(filter,a)))))))){
					HX_STACK_LINE(711)
					Float t = ray->aabbsect(a->aabb);		HX_STACK_VAR(t,"t");
					HX_STACK_LINE(712)
					if (((bool((t >= (int)0)) && bool((t < mint))))){
