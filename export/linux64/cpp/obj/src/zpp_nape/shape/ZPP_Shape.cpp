...
struct _Function_0_1{
	inline static Array< ::Dynamic > Block( ){
		...
		{
			HX_STACK_LINE(178)
			::nape::shape::ShapeType _g;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(178)
			{
				HX_STACK_LINE(178)
				...
				HX_STACK_LINE(178)
				_g = ::zpp_nape::util::ZPP_Flags_obj::ShapeType_CIRCLE;
			}
			...
			HX_STACK_LINE(178)
			return Array_obj< ::Dynamic >::__new().Add(_g).Add(_Function_1_1::Block());
		}
		return null();
	}
};
