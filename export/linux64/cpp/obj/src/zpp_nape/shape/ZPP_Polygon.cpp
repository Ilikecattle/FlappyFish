		...
		if (((this->lverts->length < (int)3))){
			struct _Function_3_1{
				inline static ::nape::shape::ValidationResult Block( ::zpp_nape::shape::ZPP_Polygon_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/shape/Polygon.hx",373,0x571b0a14)
					{
						HX_STACK_LINE(373)
			...
			if (((this->area < ::nape::Config_obj::epsilon))){
				struct _Function_4_1{
					inline static ::nape::shape::ValidationResult Block( ::zpp_nape::shape::ZPP_Polygon_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/shape/Polygon.hx",377,0x571b0a14)
						{
							HX_STACK_LINE(377)
							if (((::zpp_nape::util::ZPP_Flags_obj::ValidationResult_DEGENERATE == null()))){
								HX_STACK_LINE(377)
...
while((false));
				...
				if (((bool(pos) && bool(neg)))){
					struct _Function_5_1{
						inline static ::nape::shape::ValidationResult Block( ::zpp_nape::shape::ZPP_Polygon_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/shape/Polygon.hx",475,0x571b0a14)
							{
								HX_STACK_LINE(475)
...
while((false));
					...
					if ((!(cont))){
						struct _Function_6_1{
							inline static ::nape::shape::ValidationResult Block( ::zpp_nape::shape::ZPP_Polygon_obj *__this){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/shape/Polygon.hx",694,0x571b0a14)
								{
									HX_STACK_LINE(694)
						...
						struct _Function_6_1{
							inline static ::nape::shape::ValidationResult Block( ::zpp_nape::shape::ZPP_Polygon_obj *__this){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/shape/Polygon.hx",695,0x571b0a14)
								{
									HX_STACK_LINE(695)
		...
		while(((cur != null()))){
			...
			struct _Function_2_1{
				inline static Float Block( ::zpp_nape::geom::ZPP_Vec2 &v,::zpp_nape::geom::ZPP_Vec2 &u){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/shape/Polygon.hx",831,0x571b0a14)
					{
						HX_STACK_LINE(831)
...
::zpp_nape::shape::ZPP_Polygon ZPP_Polygon_obj::__copy( ){
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2List Block( ::zpp_nape::shape::ZPP_Polygon_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/shape/Polygon.hx",1927,0x571b0a14)
			{
				HX_STACK_LINE(1927)
