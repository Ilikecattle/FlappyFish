...
::nape::constraint::Constraint ZPP_LineJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2 Block( ::zpp_nape::constraint::ZPP_LineJoint_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/LineJoint.hx",443,0x4b59f258)
			{
				HX_STACK_LINE(443)
	...
	HX_STACK_LINE(443)
	Array< ::Dynamic > ret = Array_obj< ::Dynamic >::__new().Add(::nape::constraint::LineJoint_obj::__new(null(),null(),_g,_g1,_Function_1_1::Block(this),this->jointMin,this->jointMax));		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(444)
...
Void ZPP_LineJoint_obj::draw( ::nape::util::Debug g){
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::LineJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/LineJoint.hx",1573,0x4b59f258)
				{
					HX_STACK_LINE(1573)
		...
		struct _Function_1_2{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::LineJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/LineJoint.hx",1574,0x4b59f258)
				{
					HX_STACK_LINE(1574)
		...
		struct _Function_1_3{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::LineJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/LineJoint.hx",1575,0x4b59f258)
				{
					HX_STACK_LINE(1575)
		...
		struct _Function_1_4{
			inline static Float Block( ::nape::geom::Vec2 &dir){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/LineJoint.hx",1576,0x4b59f258)
				{
					HX_STACK_LINE(1576)
					...
					HX_STACK_LINE(1576)
					_g1 = (_g * _Function_2_1::Block(dir));
					HX_STACK_LINE(1576)
					...
					HX_STACK_LINE(1576)
					return ::Math_obj::sqrt((_g1 + (_g2 * _Function_2_2::Block(dir))));
				}
				return null();
			}
		};
				...
				if (((pn > this->jointMax))){
					...
					HX_STACK_LINE(1598)
					{
						...
						if (((ret->zpp_inner == null()))){
							...
							HX_STACK_LINE(1598)
							if ((!(((  (((_Function_6_1::Block(ret) == x))) ? bool((_Function_6_2::Block(ret) == y)) : bool(false) ))))){
								HX_STACK_LINE(1598)
								{
									HX_STACK_LINE(1598)
									ret->zpp_inner->x = x;
