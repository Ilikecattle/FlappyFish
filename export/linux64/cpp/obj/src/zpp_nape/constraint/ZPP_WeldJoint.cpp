...
::nape::constraint::Constraint ZPP_WeldJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2 Block( ::zpp_nape::constraint::ZPP_WeldJoint_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/WeldJoint.hx",332,0xc793a26a)
			{
				HX_STACK_LINE(332)
	...
	HX_STACK_LINE(332)
	Array< ::Dynamic > ret = Array_obj< ::Dynamic >::__new().Add(::nape::constraint::PivotJoint_obj::__new(null(),null(),_g,_Function_1_1::Block(this)));		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(333)
	...
	if (((bool((dict != null())) && bool((this->b1 != null()))))){
		...
		HX_STACK_LINE(345)
		{
			...
			while(((_g1 < dict->length))){
				HX_STACK_LINE(345)
				::zpp_nape::constraint::ZPP_CopyHelper idc = dict->__get(_g1).StaticCast< ::zpp_nape::constraint::ZPP_CopyHelper >();		HX_STACK_VAR(idc,"idc");
				HX_STACK_LINE(345)
				++(_g1);
				HX_STACK_LINE(346)
...
bool ZPP_WeldJoint_obj::applyImpulsePos( ){
	...
	HX_STACK_LINE(1196)
	Float _g = (Ez * Ez);		HX_STACK_VAR(_g,"_g");
	struct _Function_1_1{
...
Void ZPP_WeldJoint_obj::draw( ::nape::util::Debug g){
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/WeldJoint.hx",1533,0xc793a26a)
				{
					HX_STACK_LINE(1533)
		...
		struct _Function_1_2{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/WeldJoint.hx",1534,0xc793a26a)
				{
					HX_STACK_LINE(1534)
		...
		if ((!(this->stiff))){
			...
			HX_STACK_LINE(1537)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &n){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/WeldJoint.hx",1537,0xc793a26a)
						{
							HX_STACK_LINE(1537)
							if (((bool((n != null())) && bool(n->zpp_disp)))){
								HX_STACK_LINE(1537)
				...
				HX_STACK_LINE(1537)
				nl = ::Math_obj::sqrt((_g1 + (_g2 * _Function_3_2::Block(n))));
			}
			HX_STACK_LINE(1538)
			if (((nl != (int)0))){
				HX_STACK_LINE(1538)
			...
			{
				HX_STACK_LINE(1543)
				::nape::phys::Body _g3;		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(1543)
				...
				HX_STACK_LINE(1543)
				if (((_g3 != (_Function_3_1::Block(me))->zpp_inner->__static))){
					HX_STACK_LINE(1544)
					...
					struct _Function_4_1{
						inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/WeldJoint.hx",1551,0xc793a26a)
							{
								HX_STACK_LINE(1551)
								::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(1551)
					...
					HX_STACK_LINE(1551)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiralSpring(g,_Function_4_1::Block(me),min,max,(minrad + (((min - min)) * delrad)),(minrad + (((max - min)) * delrad)),(int)16711808,null());
					HX_STACK_LINE(1552)
					...
					HX_STACK_LINE(1552)
					::nape::phys::Body _g5;		HX_STACK_VAR(_g5,"_g5");
					HX_STACK_LINE(1552)
					if (((me->zpp_inner_zn->b1 == null()))){
						HX_STACK_LINE(1552)
						_g5 = null();
						...
						HX_STACK_LINE(1552)
						_g5 = me->zpp_inner_zn->b1->outer;
					}
					HX_STACK_LINE(1552)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::indicator(g,_g4,_g5->zpp_inner->rot,(minrad + (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot - min)) * delrad)),(int)16711808);
				}
			}
			HX_STACK_LINE(1555)
			{
				...
				HX_STACK_LINE(1556)
				if (((_g6 != (_Function_3_1::Block(me))->zpp_inner->__static))){
					HX_STACK_LINE(1557)
					...
					struct _Function_4_1{
						inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/WeldJoint.hx",1564,0xc793a26a)
							{
								HX_STACK_LINE(1564)
								::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(1564)
					...
					HX_STACK_LINE(1564)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiralSpring(g,_Function_4_1::Block(me),min,max,(minrad + (((min - min)) * delrad)),(minrad + (((max - min)) * delrad)),(int)8388863,null());
					HX_STACK_LINE(1565)
					...
					HX_STACK_LINE(1565)
					::nape::phys::Body _g8;		HX_STACK_VAR(_g8,"_g8");
					HX_STACK_LINE(1565)
					if (((me->zpp_inner_zn->b2 == null()))){
						HX_STACK_LINE(1565)
						_g8 = null();
						...
						HX_STACK_LINE(1565)
						_g8 = me->zpp_inner_zn->b2->outer;
					}
					HX_STACK_LINE(1565)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::indicator(g,_g7,_g8->zpp_inner->rot,(minrad + (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot - min)) * delrad)),(int)8388863);
				}
			}
		}
		HX_STACK_LINE(1569)
