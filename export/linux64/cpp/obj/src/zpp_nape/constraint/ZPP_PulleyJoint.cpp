		...
		if (((b == this->b1))){
				...
				HX_STACK_LINE(357)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",357,0xdaffcadd)
							{
								HX_STACK_LINE(357)
			...
			HX_STACK_LINE(358)
			{
				...
				HX_STACK_LINE(358)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",358,0xdaffcadd)
							{
								HX_STACK_LINE(358)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(358)
			...
			HX_STACK_LINE(359)
			{
				...
				HX_STACK_LINE(359)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",359,0xdaffcadd)
							{
								HX_STACK_LINE(359)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(359)
		...
		if (((b == this->b2))){
			HX_STACK_LINE(362)
			{
				...
				HX_STACK_LINE(362)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",362,0xdaffcadd)
							{
								HX_STACK_LINE(362)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(362)
			...
			HX_STACK_LINE(363)
			{
				...
				HX_STACK_LINE(363)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",363,0xdaffcadd)
							{
								HX_STACK_LINE(363)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(363)
			...
			HX_STACK_LINE(364)
			{
				...
				HX_STACK_LINE(364)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",364,0xdaffcadd)
							{
								HX_STACK_LINE(364)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(364)
		...
		if (((b == this->b3))){
			HX_STACK_LINE(367)
			{
				...
				HX_STACK_LINE(367)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",367,0xdaffcadd)
							{
								HX_STACK_LINE(367)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(367)
			...
			HX_STACK_LINE(368)
			{
				...
				HX_STACK_LINE(368)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",368,0xdaffcadd)
							{
								HX_STACK_LINE(368)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(368)
			...
			HX_STACK_LINE(369)
			{
				...
				HX_STACK_LINE(369)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",369,0xdaffcadd)
							{
								HX_STACK_LINE(369)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(369)
		...
		if (((b == this->b4))){
			HX_STACK_LINE(372)
			{
				...
				HX_STACK_LINE(372)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",372,0xdaffcadd)
							{
								HX_STACK_LINE(372)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(372)
			...
			HX_STACK_LINE(373)
			{
				...
				HX_STACK_LINE(373)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",373,0xdaffcadd)
							{
								HX_STACK_LINE(373)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(373)
			...
			HX_STACK_LINE(374)
			{
				...
				HX_STACK_LINE(374)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",374,0xdaffcadd)
							{
								HX_STACK_LINE(374)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(374)
...
::nape::constraint::Constraint ZPP_PulleyJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2 Block( ::zpp_nape::constraint::ZPP_PulleyJoint_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",647,0xdaffcadd)
			{
				HX_STACK_LINE(647)
	...
	HX_STACK_LINE(647)
	Array< ::Dynamic > ret = Array_obj< ::Dynamic >::__new().Add(::nape::constraint::PulleyJoint_obj::__new(null(),null(),null(),null(),_g,_g1,_g2,_Function_1_1::Block(this),this->jointMin,this->jointMax,this->ratio));		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(648)
...
bool ZPP_PulleyJoint_obj::preStep( Float dt){
	...
	HX_STACK_LINE(1187)
	{
		...
		if (((C34 != (int)0))){
			...
			HX_STACK_LINE(1243)
			Float t = (Float(this->ratio) / Float(::Math_obj::sqrt(((this->n34x * this->n34x) + (this->n34y * this->n34y)))));		HX_STACK_VAR(t,"t");
			HX_STACK_LINE(1252)
			hx::MultEq(this->n34x,t);
			HX_STACK_LINE(1253)
			hx::MultEq(this->n34y,t);
...
Void ZPP_PulleyJoint_obj::draw( ::nape::util::Debug g){
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PulleyJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",2194,0xdaffcadd)
				{
					HX_STACK_LINE(2194)
		...
		struct _Function_1_2{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PulleyJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",2195,0xdaffcadd)
				{
					HX_STACK_LINE(2195)
		...
		struct _Function_1_3{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PulleyJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",2196,0xdaffcadd)
				{
					HX_STACK_LINE(2196)
		...
		struct _Function_1_4{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PulleyJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",2197,0xdaffcadd)
				{
					HX_STACK_LINE(2197)
		...
		HX_STACK_LINE(2200)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &n12){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",2200,0xdaffcadd)
					{
						HX_STACK_LINE(2200)
						if (((bool((n12 != null())) && bool(n12->zpp_disp)))){
							HX_STACK_LINE(2200)
			...
			HX_STACK_LINE(2200)
			_g1 = (_g * _Function_2_1::Block(n12));
			HX_STACK_LINE(2200)
			...
			HX_STACK_LINE(2200)
			nl12 = ::Math_obj::sqrt((_g1 + (_g2 * _Function_2_2::Block(n12))));
		}
		HX_STACK_LINE(2201)
		...
		HX_STACK_LINE(2201)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &n34){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PulleyJoint.hx",2201,0xdaffcadd)
					{
						HX_STACK_LINE(2201)
						if (((bool((n34 != null())) && bool(n34->zpp_disp)))){
							HX_STACK_LINE(2201)
			...
			HX_STACK_LINE(2201)
			_g4 = (_g3 * _Function_2_1::Block(n34));
			HX_STACK_LINE(2201)
			...
			HX_STACK_LINE(2201)
			nl34 = ::Math_obj::sqrt((_g4 + (_g5 * _Function_2_2::Block(n34))));
		}
		HX_STACK_LINE(2202)
