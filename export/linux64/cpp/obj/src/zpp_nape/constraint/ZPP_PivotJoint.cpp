...
::nape::constraint::Constraint ZPP_PivotJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2 Block( ::zpp_nape::constraint::ZPP_PivotJoint_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PivotJoint.hx",326,0x4ef23406)
			{
				HX_STACK_LINE(326)
...
Void ZPP_PivotJoint_obj::validate( ){
{
		...
		if (((bool((this->b1->space != this->space)) || bool((this->b2->space != this->space))))){
			HX_STACK_LINE(484)
			::String _g = ((HX_CSTRING("Error: Constraints must have each body within the same space to which the constraint has been assigned (body1=") + this->b1->outer->toString()) + HX_CSTRING(", body2="));		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(484)
			HX_STACK_DO_THROW(((_g + this->b2->outer->toString()) + HX_CSTRING(")")));
		}
		HX_STACK_LINE(485)
		if (((bool(!(((this->b1->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_DYNAMIC)))) && bool(!(((this->b2->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_DYNAMIC))))))){
			HX_STACK_LINE(485)
			::String _g1 = ((HX_CSTRING("Error: Constraints cannot have both bodies non-dynamic (body1=") + this->b1->outer->toString()) + HX_CSTRING(", body2="));		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(485)
			HX_STACK_DO_THROW(((_g1 + this->b2->outer->toString()) + HX_CSTRING(")")));
		}
	}
return null();
}
...
Void ZPP_PivotJoint_obj::draw( ::nape::util::Debug g){
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PivotJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PivotJoint.hx",1344,0x4ef23406)
				{
					HX_STACK_LINE(1344)
		...
		struct _Function_1_2{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PivotJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PivotJoint.hx",1345,0x4ef23406)
				{
					HX_STACK_LINE(1345)
			...
			HX_STACK_LINE(1348)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &n){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/PivotJoint.hx",1348,0x4ef23406)
						{
							HX_STACK_LINE(1348)
							if (((bool((n != null())) && bool(n->zpp_disp)))){
								HX_STACK_LINE(1348)
