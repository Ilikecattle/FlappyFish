...
::nape::constraint::Constraint ZPP_DistanceJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2 Block( ::zpp_nape::constraint::ZPP_DistanceJoint_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/DistanceJoint.hx",434,0x52959e99)
			{
				HX_STACK_LINE(434)
	...
	HX_STACK_LINE(434)
	Array< ::Dynamic > ret = Array_obj< ::Dynamic >::__new().Add(::nape::constraint::DistanceJoint_obj::__new(null(),null(),_g,_Function_1_1::Block(this),this->jointMin,this->jointMax));		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(435)
...
Void ZPP_DistanceJoint_obj::draw( ::nape::util::Debug g){
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::DistanceJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/DistanceJoint.hx",1290,0x52959e99)
				{
					HX_STACK_LINE(1290)
		...
		struct _Function_1_2{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::DistanceJoint &me){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/DistanceJoint.hx",1291,0x52959e99)
				{
					HX_STACK_LINE(1291)
		...
		HX_STACK_LINE(1293)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &n){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/DistanceJoint.hx",1293,0x52959e99)
					{
						HX_STACK_LINE(1293)
						if (((bool((n != null())) && bool(n->zpp_disp)))){
							HX_STACK_LINE(1293)
			...
			HX_STACK_LINE(1293)
			nl = ::Math_obj::sqrt((_g1 + (_g2 * _Function_2_2::Block(n))));
		}
		HX_STACK_LINE(1294)
		if (((nl != (int)0))){
			HX_STACK_LINE(1295)
