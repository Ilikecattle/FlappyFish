...
bool ZPP_UserConstraint_obj::preStep( Float dt){
	...
	if (((bool(!(this->stiff)) && bool(!(this->velonly))))){
		...
		HX_STACK_LINE(463)
		if (((  ((this->breakUnderError)) ? bool((this->lsq(this->bias) > (this->maxError * this->maxError))) : bool(false) ))){
			HX_STACK_LINE(463)
			return true;
		}
		HX_STACK_LINE(464)
...
Void ZPP_UserConstraint_obj::warmStart( ){
{
		...
		while(((_g < _g1->length))){
			...
			HX_STACK_LINE(481)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",491,0x968ba4a6)
						{
							HX_STACK_LINE(491)
				...
				struct _Function_3_2{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",492,0x968ba4a6)
						{
							HX_STACK_LINE(492)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(492)
			...
			struct _Function_2_1{
				inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",494,0x968ba4a6)
					{
						HX_STACK_LINE(494)
						::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(494)
...
bool ZPP_UserConstraint_obj::applyImpulseVel( ){
	...
	HX_STACK_LINE(508)
	if (((  (((bool(this->breakUnderForce) || bool(!(this->stiff))))) ? bool((this->lsq(this->jAcc) > (this->jMax * this->jMax))) : bool(false) ))){
		HX_STACK_LINE(509)
		...
		while(((_g < _g1->length))){
			...
			HX_STACK_LINE(516)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",526,0x968ba4a6)
						{
							HX_STACK_LINE(526)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(526)
				...
				struct _Function_4_2{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",527,0x968ba4a6)
						{
							HX_STACK_LINE(527)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(527)
			...
			struct _Function_3_1{
				inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",529,0x968ba4a6)
					{
						HX_STACK_LINE(529)
						::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(529)
	...
	HX_STACK_LINE(544)
	{
		...
		while(((_g < _g1->length))){
			...
			HX_STACK_LINE(547)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",557,0x968ba4a6)
						{
							HX_STACK_LINE(557)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(557)
				...
				struct _Function_4_2{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",558,0x968ba4a6)
						{
							HX_STACK_LINE(558)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(558)
			...
			HX_STACK_LINE(560)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/UserConstraint.hx",560,0x968ba4a6)
						{
							HX_STACK_LINE(560)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(560)
