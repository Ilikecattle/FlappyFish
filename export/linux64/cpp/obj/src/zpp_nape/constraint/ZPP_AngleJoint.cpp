...
Void ZPP_AngleJoint_obj::draw( ::nape::util::Debug g){
{
		...
		HX_STACK_LINE(583)
		if (((_g != (_Function_1_1::Block(me))->zpp_inner->__static))){
			HX_STACK_LINE(584)
			...
			if (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot > min))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/AngleJoint.hx",597,0x575b2617)
						{
							HX_STACK_LINE(597)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(597)
				...
				if (((bool(!(this->stiff)) && bool((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot < min))))){
					...
					HX_STACK_LINE(600)
					::nape::phys::Body _g2;		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(600)
					if (((me->zpp_inner_zn->b1 == null()))){
						HX_STACK_LINE(600)
						_g2 = null();
						...
						HX_STACK_LINE(600)
						_g2 = me->zpp_inner_zn->b1->outer;
					}
					HX_STACK_LINE(600)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiralSpring(g,_g1,_g2->zpp_inner->rot,min,(minrad + (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot - min)) * delrad)),(minrad + (((min - min)) * delrad)),(int)16776960,null());
				}
			}
			HX_STACK_LINE(602)
			if (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot < max))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/AngleJoint.hx",608,0x575b2617)
						{
							HX_STACK_LINE(608)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(608)
				...
				if (((bool(!(this->stiff)) && bool((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot > max))))){
					...
					HX_STACK_LINE(611)
					::nape::phys::Body _g4;		HX_STACK_VAR(_g4,"_g4");
					HX_STACK_LINE(611)
					if (((me->zpp_inner_zn->b1 == null()))){
						HX_STACK_LINE(611)
						_g4 = null();
						...
						HX_STACK_LINE(611)
						_g4 = me->zpp_inner_zn->b1->outer;
					}
					HX_STACK_LINE(611)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiralSpring(g,_g3,_g4->zpp_inner->rot,max,(minrad + (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot - min)) * delrad)),(minrad + (((max - min)) * delrad)),(int)65535,null());
				}
			}
			HX_STACK_LINE(613)
			...
			HX_STACK_LINE(613)
			::nape::phys::Body _g6;		HX_STACK_VAR(_g6,"_g6");
			HX_STACK_LINE(613)
			if (((me->zpp_inner_zn->b1 == null()))){
				HX_STACK_LINE(613)
				_g6 = null();
				...
				HX_STACK_LINE(613)
				_g6 = me->zpp_inner_zn->b1->outer;
			}
			HX_STACK_LINE(613)
			::zpp_nape::constraint::ZPP_AngleDraw_obj::indicator(g,_g5,_g6->zpp_inner->rot,(minrad + (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot - min)) * delrad)),(int)255);
		}
		HX_STACK_LINE(615)
		::nape::phys::Body _g7;		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(615)
		...
		HX_STACK_LINE(615)
		if (((_g7 != (_Function_1_2::Block(me))->zpp_inner->__static))){
			HX_STACK_LINE(616)
			...
			if (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot > min))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/AngleJoint.hx",629,0x575b2617)
						{
							HX_STACK_LINE(629)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(629)
				...
				if (((bool(!(this->stiff)) && bool((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot < min))))){
					...
					HX_STACK_LINE(632)
					::nape::phys::Body _g9;		HX_STACK_VAR(_g9,"_g9");
					HX_STACK_LINE(632)
					if (((me->zpp_inner_zn->b2 == null()))){
						HX_STACK_LINE(632)
						_g9 = null();
						...
						HX_STACK_LINE(632)
						_g9 = me->zpp_inner_zn->b2->outer;
					}
					HX_STACK_LINE(632)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiralSpring(g,_g8,_g9->zpp_inner->rot,min,(minrad + (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot - min)) * delrad)),(minrad + (((min - min)) * delrad)),(int)16776960,null());
				}
			}
			HX_STACK_LINE(634)
			if (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot < max))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/constraint/AngleJoint.hx",640,0x575b2617)
						{
							HX_STACK_LINE(640)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(640)
				...
				if (((bool(!(this->stiff)) && bool((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot > max))))){
					...
					HX_STACK_LINE(643)
					::nape::phys::Body _g11;		HX_STACK_VAR(_g11,"_g11");
					HX_STACK_LINE(643)
					if (((me->zpp_inner_zn->b2 == null()))){
						HX_STACK_LINE(643)
						_g11 = null();
						...
						HX_STACK_LINE(643)
						_g11 = me->zpp_inner_zn->b2->outer;
					}
					HX_STACK_LINE(643)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiralSpring(g,_g10,_g11->zpp_inner->rot,max,(minrad + (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot - min)) * delrad)),(minrad + (((max - min)) * delrad)),(int)65535,null());
				}
			}
			HX_STACK_LINE(645)
			...
			HX_STACK_LINE(645)
			::nape::phys::Body _g13;		HX_STACK_VAR(_g13,"_g13");
			HX_STACK_LINE(645)
			if (((me->zpp_inner_zn->b2 == null()))){
				HX_STACK_LINE(645)
				_g13 = null();
				...
				HX_STACK_LINE(645)
				_g13 = me->zpp_inner_zn->b2->outer;
			}
			HX_STACK_LINE(645)
			::zpp_nape::constraint::ZPP_AngleDraw_obj::indicator(g,_g12,_g13->zpp_inner->rot,(minrad + (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot - min)) * delrad)),(int)16711680);
		}
	}
return null();
}
