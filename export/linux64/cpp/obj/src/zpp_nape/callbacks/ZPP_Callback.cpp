...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_Callback","rotateL",0xc50dfb6e,"zpp_nape.callbacks.ZPP_Callback.rotateL","zpp_nape/callbacks/Callback.hx",314,0x948ca4f6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(314)
		this->push(this->pop());
	}
...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_Callback","rotateR",0xc50dfb74,"zpp_nape.callbacks.ZPP_Callback.rotateR","zpp_nape/callbacks/Callback.hx",317,0x948ca4f6)
		HX_STACK_THIS(this)
		HX_STACK_LINE(317)
