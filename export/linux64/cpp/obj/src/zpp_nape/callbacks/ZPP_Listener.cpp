...
struct _Function_0_1{
	inline static Array< ::Dynamic > Block( ){
		...
		{
			HX_STACK_LINE(182)
			::nape::callbacks::ListenerType _g;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(182)
			{
				HX_STACK_LINE(182)
				...
				HX_STACK_LINE(182)
				_g = ::zpp_nape::util::ZPP_Flags_obj::ListenerType_BODY;
			}
			HX_STACK_LINE(182)
			...
			HX_STACK_LINE(182)
			{
				...
				HX_STACK_LINE(182)
				_g1 = ::zpp_nape::util::ZPP_Flags_obj::ListenerType_CONSTRAINT;
			}
			HX_STACK_LINE(182)
			::nape::callbacks::ListenerType _g2;		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(182)
			{
				HX_STACK_LINE(182)
				...
				HX_STACK_LINE(182)
				_g2 = ::zpp_nape::util::ZPP_Flags_obj::ListenerType_INTERACTION;
			}
			...
			HX_STACK_LINE(182)
			return Array_obj< ::Dynamic >::__new().Add(_g).Add(_g1).Add(_g2).Add(_Function_1_1::Block());
		}
		return null();
	}
};
...
struct _Function_0_2{
	inline static Array< ::Dynamic > Block( ){
		...
		{
			HX_STACK_LINE(183)
			::nape::callbacks::CbEvent _g;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(183)
			{
				HX_STACK_LINE(183)
				...
				HX_STACK_LINE(183)
				_g = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_BEGIN;
			}
			HX_STACK_LINE(183)
			...
			HX_STACK_LINE(183)
			{
				...
				HX_STACK_LINE(183)
				_g1 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_END;
			}
			HX_STACK_LINE(183)
			::nape::callbacks::CbEvent _g2;		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(183)
			{
				HX_STACK_LINE(183)
				...
				HX_STACK_LINE(183)
				_g2 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_WAKE;
			}
			HX_STACK_LINE(183)
			...
			HX_STACK_LINE(183)
			::nape::callbacks::CbEvent _g4;		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(183)
			{
				HX_STACK_LINE(183)
				...
				HX_STACK_LINE(183)
				_g4 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_BREAK;
			}
			HX_STACK_LINE(183)
			...
			HX_STACK_LINE(183)
			{
				...
				HX_STACK_LINE(183)
				_g5 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_PRE;
			}
			struct _Function_1_1{
			...
			HX_STACK_LINE(183)
			return Array_obj< ::Dynamic >::__new().Add(_g).Add(_g1).Add(_g2).Add(_g3).Add(_g4).Add(_g5).Add(_Function_1_1::Block());
		}
		return null();
	}
};
