				...
				inline static ::nape::geom::Vec2 Block( Float &ny,Float &nx){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",583,0x908d5ea5)
					{
						...
						if (((ret->zpp_inner == null()))){
							...
							HX_STACK_LINE(583)
							if ((!(((  (((_Function_5_1::Block(ret) == nx))) ? bool((_Function_5_2::Block(ret) == ny)) : bool(false) ))))){
								HX_STACK_LINE(583)
								{
									HX_STACK_LINE(583)
									ret->zpp_inner->x = nx;
					...
					inline static ::nape::geom::Vec2 Block( Float &ny,Float &nx){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",671,0x908d5ea5)
						{
							...
							if (((ret->zpp_inner == null()))){
								...
								HX_STACK_LINE(671)
								if ((!(((  (((_Function_6_1::Block(ret) == nx))) ? bool((_Function_6_2::Block(ret) == ny)) : bool(false) ))))){
									HX_STACK_LINE(671)
									{
										HX_STACK_LINE(671)
										ret->zpp_inner->x = nx;
						...
						inline static ::nape::geom::Vec2 Block( Float &ny,Float &nx){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",754,0x908d5ea5)
							{
								...
								if (((ret->zpp_inner == null()))){
									...
									HX_STACK_LINE(754)
									if ((!(((  (((_Function_7_1::Block(ret) == nx))) ? bool((_Function_7_2::Block(ret) == ny)) : bool(false) ))))){
										HX_STACK_LINE(754)
										{
											HX_STACK_LINE(754)
											ret->zpp_inner->x = nx;
						...
						while(((cx_ite != null()))){
							...
							HX_STACK_LINE(860)
							{
								...
								HX_STACK_LINE(861)
								{
									...
									HX_STACK_LINE(861)
									_g = res->zpp_inner->toiDistance;
								}
								struct _Function_7_1{
									inline static Float Block( ::nape::geom::RayResult &j){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",861,0x908d5ea5)
										{
											HX_STACK_LINE(861)
						...
						while(((cx_ite != null()))){
							...
							HX_STACK_LINE(961)
							{
								...
								HX_STACK_LINE(962)
								{
									...
									HX_STACK_LINE(962)
									_g1 = res->zpp_inner->toiDistance;
								}
								struct _Function_7_1{
									inline static Float Block( ::nape::geom::RayResult &j){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",962,0x908d5ea5)
										{
											HX_STACK_LINE(962)
											if (((j->zpp_inner->next != null()))){
												HX_STACK_LINE(962)
						...
						while(((cx_ite != null()))){
							...
							HX_STACK_LINE(1056)
							{
								...
								HX_STACK_LINE(1057)
								{
									...
									HX_STACK_LINE(1057)
									_g2 = res->zpp_inner->toiDistance;
								}
								struct _Function_7_1{
									inline static Float Block( ::nape::geom::RayResult &j){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",1057,0x908d5ea5)
										{
											HX_STACK_LINE(1057)
											if (((j->zpp_inner->next != null()))){
												HX_STACK_LINE(1057)
			...
			inline static ::nape::geom::Vec2 Block( Float &ny,Float &nx){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",1181,0x908d5ea5)
				{
					...
					if (((ret->zpp_inner == null()))){
						...
						HX_STACK_LINE(1181)
						if ((!(((  (((_Function_4_1::Block(ret) == nx))) ? bool((_Function_4_2::Block(ret) == ny)) : bool(false) ))))){
							HX_STACK_LINE(1181)
							{
								HX_STACK_LINE(1181)
								ret->zpp_inner->x = nx;
					...
					while(((cx_ite != null()))){
						...
						HX_STACK_LINE(1319)
						{
							...
							HX_STACK_LINE(1320)
							{
								...
								HX_STACK_LINE(1320)
								_g = ret->zpp_inner->toiDistance;
							}
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::RayResult &j){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",1320,0x908d5ea5)
									{
										HX_STACK_LINE(1320)
										if (((j->zpp_inner->next != null()))){
											HX_STACK_LINE(1320)
					...
					while(((cx_ite != null()))){
						...
						HX_STACK_LINE(1364)
						{
							...
							HX_STACK_LINE(1365)
							{
								...
								HX_STACK_LINE(1365)
								_g1 = ret->zpp_inner->toiDistance;
							}
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::RayResult &j){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Ray.hx",1365,0x908d5ea5)
									{
										HX_STACK_LINE(1365)
										if (((j->zpp_inner->next != null()))){
											HX_STACK_LINE(1365)
