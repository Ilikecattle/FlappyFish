								...
								if (((bool((rightSize == (int)0)) || bool((right == null()))))){
									...
									struct _Function_8_1{
										inline static int Block( Float &vx,::zpp_nape::geom::ZPP_PartitionVertex_obj *__this,Float &uy,Float &ux,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &left,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &right,Float &vy){
											HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/PartitionedPoly.hx",375,0x0d312f3a)
											{
												HX_STACK_LINE(376)
												{
													HX_STACK_LINE(377)
										...
										inline static bool Block( Float &vx,::zpp_nape::geom::ZPP_PartitionVertex_obj *__this,Float &uy,Float &ux,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &left,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &right,Float &vy){
											HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/PartitionedPoly.hx",388,0x0d312f3a)
											{
												...
												struct _Function_9_1{
													inline static int Block( Float &vx,::zpp_nape::geom::ZPP_PartitionVertex_obj *__this,Float &uy,Float &ux,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &left,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &right,Float &vy){
														HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/PartitionedPoly.hx",414,0x0d312f3a)
														{
															HX_STACK_LINE(415)
															{
																HX_STACK_LINE(416)
												...
												HX_STACK_LINE(413)
												return (  (((bool(((d1 * d2) == (int)1)) || bool((bool(((d1 * d2) == (int)0)) && bool(((bool((d1 == (int)1)) || bool((d2 == (int)1)))))))))) ? bool((_Function_9_1::Block(vx,__this,uy,ux,left,right,vy) == (int)1)) : bool((  (((bool((d1 == (int)-1)) || bool((d2 == (int)-1))))) ? bool((d2 == (int)-1)) : bool((  (((bool((d1 == (int)0)) && bool((d2 == (int)0))))) ? bool(_Function_9_2::Block(vx,__this,uy,ux,left,right,vy)) : bool(true) )) )) );
											}
											return null();
										}
									};
		...
		if (((q == p->next))){
			...
			if (((p->y == p->next->y))){
				...
				if (((q->y == q->next->y))){
					...
					HX_STACK_LINE(538)
					return (_g > _Function_5_1::Block(q));
				}
				else{
					HX_STACK_LINE(546)
					if ((!(((::zpp_nape::geom::ZPP_PartitionVertex_obj::rightdistance(q,p) > 0.0))))){
						HX_STACK_LINE(546)
						return (::zpp_nape::geom::ZPP_PartitionVertex_obj::rightdistance(q,p->next) > 0.0);
					}
					else{
						HX_STACK_LINE(546)
						return true;
				...
				if (((bool((qRight == (int)0)) && bool((qNextRight == (int)0))))){
					...
					HX_STACK_LINE(552)
					return (_g1 > _Function_5_1::Block(q));
				}
				HX_STACK_LINE(562)
