			...
			if (((p->left->x == p->right->x))){
				...
				struct _Function_4_1{
					inline static Float Block( Float &vx,Float &uy,Float &ux,::zpp_nape::geom::ZPP_SimpleSeg &p,Float &vy,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Simple.hx",505,0x62f156db)
						{
							HX_STACK_LINE(506)
				...
				HX_STACK_LINE(505)
				return (_Function_4_1::Block(vx,uy,ux,p,vy,flip,q) < (int)0);
			}
		}
		else{
			HX_STACK_LINE(518)
				...
				if (((p->left == q->left))){
					...
					if (((p->left->x == p->right->x))){
						...
						struct _Function_6_1{
							inline static Float Block( Float &vx,Float &uy,Float &ux,::zpp_nape::geom::ZPP_SimpleSeg &p,Float &vy,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Simple.hx",541,0x62f156db)
								{
									HX_STACK_LINE(542)
									flip = (p->right->x < p->left->x);
									HX_STACK_LINE(543)
						...
						HX_STACK_LINE(541)
						return (_Function_6_1::Block(vx,uy,ux,p,vy,flip,q) < (int)0);
					}
				}
				else{
					HX_STACK_LINE(554)
					if (((p->right == q->right))){
						...
						if (((p->left->x == p->right->x))){
							...
							struct _Function_7_1{
								inline static Float Block( Float &vx,Float &uy,Float &ux,::zpp_nape::geom::ZPP_SimpleSeg &p,Float &vy,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Simple.hx",559,0x62f156db)
									{
										HX_STACK_LINE(560)
										flip = (p->right->x < p->left->x);
										HX_STACK_LINE(561)
							...
							HX_STACK_LINE(559)
							return (_Function_7_1::Block(vx,uy,ux,p,vy,flip,q) < (int)0);
						}
					}
				}
			}
	...
	if (((p->left->x == p->right->x))){
		...
		if (((q->left->x == q->right->x))){
			...
			struct _Function_3_1{
				inline static Float Block( Float &vx,Float &uy,Float &ux,::zpp_nape::geom::ZPP_SimpleSeg &p,Float &vy,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Simple.hx",636,0x62f156db)
					{
						HX_STACK_LINE(637)
						flip = (p->right->x < p->left->x);
						HX_STACK_LINE(638)
			...
			HX_STACK_LINE(636)
			qlrg = (_Function_3_1::Block(vx,uy,ux,p,vy,flip,q) < 0.0);
			HX_STACK_LINE(648)
			bool aqlrg;		HX_STACK_VAR(aqlrg,"aqlrg");
			struct _Function_3_2{
				inline static Float Block( Float &vx,Float &uy,Float &ux,::zpp_nape::geom::ZPP_SimpleSeg &p,Float &vy,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Simple.hx",648,0x62f156db)
					{
						HX_STACK_LINE(649)
						flip = (p->right->x < p->left->x);
						HX_STACK_LINE(650)
			...
			HX_STACK_LINE(648)
			aqlrg = (_Function_3_2::Block(vx,uy,ux,p,vy,flip,q) < 0.0);
			HX_STACK_LINE(660)
			if (((qlrg == aqlrg))){
				HX_STACK_LINE(660)
				return qlrg;
				...
				struct _Function_4_1{
					inline static Float Block( Float &vx,Float &uy,Float &ux,::zpp_nape::geom::ZPP_SimpleSeg &p,Float &vy,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Simple.hx",662,0x62f156db)
						{
							HX_STACK_LINE(663)
							flip = (q->right->x < q->left->x);
							HX_STACK_LINE(664)
				...
				HX_STACK_LINE(662)
				plrg = (_Function_4_1::Block(vx,uy,ux,p,vy,flip,q) >= 0.0);
				HX_STACK_LINE(674)
				bool aplrg;		HX_STACK_VAR(aplrg,"aplrg");
				struct _Function_4_2{
					inline static Float Block( Float &vx,Float &uy,Float &ux,::zpp_nape::geom::ZPP_SimpleSeg &p,Float &vy,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Simple.hx",674,0x62f156db)
						{
							HX_STACK_LINE(675)
							flip = (q->right->x < q->left->x);
							HX_STACK_LINE(676)
				...
				HX_STACK_LINE(674)
				aplrg = (_Function_4_2::Block(vx,uy,ux,p,vy,flip,q) >= 0.0);
				HX_STACK_LINE(686)
				if (((plrg == aplrg))){
					HX_STACK_LINE(686)
					return plrg;
