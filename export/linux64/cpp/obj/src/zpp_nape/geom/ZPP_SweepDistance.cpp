		...
		while((true)){
			...
			struct _Function_2_1{
				inline static Float Block( ::zpp_nape::geom::ZPP_Vec2 &c1,::zpp_nape::geom::ZPP_Vec2 &c2,::zpp_nape::geom::ZPP_Vec2 &axis,::zpp_nape::shape::ZPP_Shape &s2,::zpp_nape::shape::ZPP_Shape &s1){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/SweepDistance.hx",261,0x2645f2ee)
					{
						HX_STACK_LINE(261)
			...
			HX_STACK_LINE(261)
			sep = (_Function_2_1::Block(c1,c2,axis,s2,s1) + negRadius);
			HX_STACK_LINE(262)
			...
			if (((curTOI >= (int)1))){
				...
				struct _Function_3_1{
					inline static Float Block( ::zpp_nape::geom::ZPP_Vec2 &c1,::zpp_nape::geom::ZPP_Vec2 &c2,::zpp_nape::geom::ZPP_Vec2 &axis,::zpp_nape::shape::ZPP_Shape &s2,::zpp_nape::shape::ZPP_Shape &s1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/SweepDistance.hx",301,0x2645f2ee)
						{
							HX_STACK_LINE(301)
							::zpp_nape::shape::ZPP_Shape s11 = s1;		HX_STACK_VAR(s11,"s11");
							HX_STACK_LINE(301)
				...
				HX_STACK_LINE(301)
				sep1 = (_Function_3_1::Block(c1,c2,axis,s2,s1) + negRadius);
				HX_STACK_LINE(302)
...
Void ZPP_SweepDistance_obj::staticSweep( ::zpp_nape::geom::ZPP_ToiEvent toi,Float timeStep,Float lowerBound,Float negRadius){
{
		...
		while((true)){
			...
			struct _Function_2_1{
				inline static Float Block( ::zpp_nape::geom::ZPP_Vec2 &c1,::zpp_nape::geom::ZPP_Vec2 &c2,::zpp_nape::geom::ZPP_Vec2 &axis,::zpp_nape::shape::ZPP_Shape &s2,::zpp_nape::shape::ZPP_Shape &s1){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/SweepDistance.hx",393,0x2645f2ee)
					{
						HX_STACK_LINE(393)
						::zpp_nape::shape::ZPP_Shape s11 = s1;		HX_STACK_VAR(s11,"s11");
						HX_STACK_LINE(393)
			...
			if (((curTOI >= (int)1))){
				...
				struct _Function_3_1{
					inline static Float Block( ::zpp_nape::geom::ZPP_Vec2 &c1,::zpp_nape::geom::ZPP_Vec2 &c2,::zpp_nape::geom::ZPP_Vec2 &axis,::zpp_nape::shape::ZPP_Shape &s2,::zpp_nape::shape::ZPP_Shape &s1){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/SweepDistance.hx",446,0x2645f2ee)
						{
							HX_STACK_LINE(446)
							::zpp_nape::shape::ZPP_Shape s11 = s1;		HX_STACK_VAR(s11,"s11");
							HX_STACK_LINE(446)
