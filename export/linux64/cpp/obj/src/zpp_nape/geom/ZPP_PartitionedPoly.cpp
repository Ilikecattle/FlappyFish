...
bool ZPP_PartitionedPoly_obj::eq( ::zpp_nape::geom::ZPP_PartitionVertex a,::zpp_nape::geom::ZPP_PartitionVertex b){
	HX_STACK_FRAME("zpp_nape.geom.ZPP_PartitionedPoly","eq",0x0f95783b,"zpp_nape.geom.ZPP_PartitionedPoly.eq","zpp_nape/geom/PartitionedPoly.hx",590,0x0d312f3a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	struct _Function_1_1{
		inline static Float Block( ::zpp_nape::geom::ZPP_PartitionVertex &b,::zpp_nape::geom::ZPP_PartitionVertex &a){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/PartitionedPoly.hx",590,0x0d312f3a)
			{
				HX_STACK_LINE(590)
...
Void ZPP_PartitionedPoly_obj::init( ::zpp_nape::geom::ZPP_GeomVert P){
{
		...
		struct _Function_1_1{
			inline static Float Block( ::zpp_nape::geom::ZPP_GeomVert &P){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/PartitionedPoly.hx",636,0x0d312f3a)
				{
					HX_STACK_LINE(661)
...
while(((next != start)));
	struct _Function_1_1{
		inline static Float Block( ::zpp_nape::geom::ZPP_PartitionedPoly &poly){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/PartitionedPoly.hx",1085,0x0d312f3a)
			{
				HX_STACK_LINE(1110)
				Float area = 0.0;		HX_STACK_VAR(area,"area");
				HX_STACK_LINE(1111)
				...
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/PartitionedPoly.hx",1344,0x0d312f3a)
				{
					...
					while(((bool(skip) || bool((p != poly))))){
						...
						struct _Function_4_1{
							inline static Float Block( ::zpp_nape::geom::ZPP_GeomVert &p){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/PartitionedPoly.hx",1349,0x0d312f3a)
								{
									HX_STACK_LINE(1349)
									Float dx = 0.0;		HX_STACK_VAR(dx,"dx");
									HX_STACK_LINE(1349)
