...
Float ZPP_MarchingSquares_obj::xlerp( Float x0,Float x1,Float y,Float v0,Float v1,Dynamic iso,int quality){
	...
	HX_STACK_LINE(1895)
	while(((  (((  ((((quality)-- != (int)0))) ? bool((x0 < xm)) : bool(false) ))) ? bool((xm < x1)) : bool(false) ))){
		HX_STACK_LINE(1896)
...
Float ZPP_MarchingSquares_obj::ylerp( Float y0,Float y1,Float x,Float v0,Float v1,Dynamic iso,int quality){
	...
	HX_STACK_LINE(1912)
	while(((  (((  ((((quality)-- != (int)0))) ? bool((y0 < ym)) : bool(false) ))) ? bool((ym < y1)) : bool(false) ))){
		HX_STACK_LINE(1913)
...
Void ZPP_MarchingSquares_obj::run( Dynamic iso,Float bx0,Float by0,Float bx1,Float by1,::nape::geom::Vec2 cell,int quality,bool combine,::nape::geom::GeomPolyList ret){
{
		...
		struct _Function_1_1{
			inline static Float Block( ::nape::geom::Vec2 &cell){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/MarchingSquares.hx",277,0xc3305538)
				{
					HX_STACK_LINE(277)
		...
		struct _Function_1_2{
			inline static Float Block( ::nape::geom::Vec2 &cell){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/MarchingSquares.hx",279,0xc3305538)
				{
					HX_STACK_LINE(279)
					if (((bool((cell != null())) && bool(cell->zpp_disp)))){
						HX_STACK_LINE(279)
				...
				if (((y == (int)0))){
					...
					if (((y <= yn))){
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec2 &cell){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/MarchingSquares.hx",298,0xc3305538)
								{
									HX_STACK_LINE(298)
									if (((bool((cell != null())) && bool(cell->zpp_disp)))){
										HX_STACK_LINE(298)
						...
						if (((x == (int)0))){
							...
							if (((x <= xn))){
								struct _Function_7_1{
									inline static Float Block( ::nape::geom::Vec2 &cell){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/MarchingSquares.hx",300,0xc3305538)
										{
											HX_STACK_LINE(300)
											if (((bool((cell != null())) && bool(cell->zpp_disp)))){
												HX_STACK_LINE(300)
			...
			while(((_g < yn))){
				...
				if (((y == (yn - (int)1)))){
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec2 &cell){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/MarchingSquares.hx",333,0xc3305538)
							{
								HX_STACK_LINE(333)
								if (((bool((cell != null())) && bool(cell->zpp_disp)))){
									HX_STACK_LINE(333)
					...
					while(((_g1 < xn))){
						...
						if (((x == (xn - (int)1)))){
							...
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::Vec2 &cell){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/MarchingSquares.hx",339,0xc3305538)
									{
										HX_STACK_LINE(339)
										if (((bool((cell != null())) && bool(cell->zpp_disp)))){
											HX_STACK_LINE(339)
			...
			while(((_g < yn))){
				...
				HX_STACK_LINE(449)
				{
					...
					while(((_g1 < xn))){
						...
						HX_STACK_LINE(473)
						::zpp_nape::geom::ZPP_MarchSpan _g2;		HX_STACK_VAR(_g2,"_g2");
						HX_STACK_LINE(473)
						if (((ad == ad->parent))){
							HX_STACK_LINE(473)
							_g2 = ad;
						...
						struct _Function_5_3{
							inline static ::zpp_nape::geom::ZPP_MarchSpan Block( ::zpp_nape::geom::ZPP_MarchSpan &bu){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/MarchingSquares.hx",492,0xc3305538)
								{
									HX_STACK_LINE(493)
						...
						HX_STACK_LINE(472)
						if (((_g2 == ((  (((bu == bu->parent))) ? ::zpp_nape::geom::ZPP_MarchSpan(bu) : ::zpp_nape::geom::ZPP_MarchSpan(_Function_5_3::Block(bu)) ))))){
							HX_STACK_LINE(509)
							if (((pre != bu))){
								HX_STACK_LINE(510)
