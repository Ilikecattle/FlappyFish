							...
							while((true)){
								...
								if ((poly1)){
									...
									if ((!(out1->__get(ind1)))){
										...
										HX_STACK_LINE(1606)
										if (((  (((fst_vert != null()))) ? bool((_Function_10_1::Block(ex,fst_vert) < ::nape::Config_obj::epsilon)) : bool(false) ))){
											HX_STACK_LINE(1606)
											break;
										}
										HX_STACK_LINE(1607)
...
while((false));
										...
										HX_STACK_LINE(1766)
										if (((  (((fst_vert != null()))) ? bool((_Function_10_1::Block(cx,cy,fst_vert) < ::nape::Config_obj::epsilon)) : bool(false) ))){
											HX_STACK_LINE(1766)
											break;
										}
										struct _Function_10_2{
											inline static ::zpp_nape::geom::ZPP_Vec2 Block( Float &cx,Float &cy){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1767,0x9b695611)
												{
													HX_STACK_LINE(1767)
													bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
													HX_STACK_LINE(1767)
...
while((false));
										...
										struct _Function_10_2{
											inline static ::zpp_nape::geom::ZPP_Vec2 Block( Float &cx,Float &cy){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",1945,0x9b695611)
												{
													HX_STACK_LINE(1945)
													bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
													HX_STACK_LINE(1945)
									...
									if ((ins->__get(vind))){
										struct _Function_10_1{
											inline static Float Block( ::zpp_nape::geom::ZPP_Vec2 &vi1,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2170,0x9b695611)
												{
													HX_STACK_LINE(2170)
													Float dx = 0.0;		HX_STACK_VAR(dx,"dx");
													HX_STACK_LINE(2170)
										...
										struct _Function_10_1{
											inline static Float Block( Float &cx,Float &cy,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2213,0x9b695611)
												{
													HX_STACK_LINE(2213)
													Float dx = 0.0;		HX_STACK_VAR(dx,"dx");
													HX_STACK_LINE(2213)
										...
										HX_STACK_LINE(2213)
										if (((_Function_10_1::Block(cx,cy,fst_vert) < ::nape::Config_obj::epsilon))){
											HX_STACK_LINE(2213)
											break;
										}
										struct _Function_10_2{
											inline static ::zpp_nape::geom::ZPP_Vec2 Block( Float &cx,Float &cy){
												HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2214,0x9b695611)
												{
													HX_STACK_LINE(2214)
													bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
													HX_STACK_LINE(2214)
												...
												HX_STACK_LINE(2228)
												{
													...
													if ((inte->__get(vind))){
														...
														if ((ins->__get(vind2))){
															...
															struct _Function_15_1{
																inline static Float Block( Float &cx,Float &cy,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
																	HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2270,0x9b695611)
																	{
																		HX_STACK_LINE(2270)
																		Float dx = 0.0;		HX_STACK_VAR(dx,"dx");
																		HX_STACK_LINE(2270)
															...
															HX_STACK_LINE(2270)
															if (((_Function_15_1::Block(cx,cy,fst_vert) < ::nape::Config_obj::epsilon))){
																HX_STACK_LINE(2271)
																state = (int)0;
																HX_STACK_LINE(2272)
																{
															...
															if (((bool((t0 < ((int)1 - ::nape::Config_obj::epsilon))) && bool((t1 > ::nape::Config_obj::epsilon))))){
																...
																HX_STACK_LINE(2336)
																if (((  (((fst_vert != null()))) ? bool((_Function_16_1::Block(cx,cy,fst_vert) < ::nape::Config_obj::epsilon)) : bool(false) ))){
																	HX_STACK_LINE(2337)
																	state = (int)0;
																	HX_STACK_LINE(2338)
																	{
																...
																if ((two)){
																	...
																	struct _Function_17_1{
																		inline static ::zpp_nape::geom::ZPP_Vec2 Block( Float &cy1,Float &cx1){
																			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2366,0x9b695611)
																			{
																				HX_STACK_LINE(2366)
																				bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
																				HX_STACK_LINE(2366)
												...
												HX_STACK_LINE(2381)
												{
													...
													if ((inte->__get(vind))){
														...
														if ((ins->__get(vind2))){
															...
															struct _Function_15_1{
																inline static Float Block( Float &cx,Float &cy,::zpp_nape::geom::ZPP_Vec2 &fst_vert){
																	HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2423,0x9b695611)
																	{
																		HX_STACK_LINE(2423)
																		Float dx = 0.0;		HX_STACK_VAR(dx,"dx");
																		HX_STACK_LINE(2423)
															...
															if (((bool((t0 < ((int)1 - ::nape::Config_obj::epsilon))) && bool((t1 > ::nape::Config_obj::epsilon))))){
																...
																if ((two)){
																	...
																	struct _Function_17_1{
																		inline static ::zpp_nape::geom::ZPP_Vec2 Block( Float &cy1,Float &cx1){
																			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","zpp_nape/geom/Collide.hx",2519,0x9b695611)
																			{
																				HX_STACK_LINE(2519)
																				bool immutable = false;		HX_STACK_VAR(immutable,"immutable");
																				HX_STACK_LINE(2519)
