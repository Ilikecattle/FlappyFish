...
::String ArbiterType_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::dynamics::ArbiterType Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ArbiterType.hx",192,0xeb73a8ef)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::dynamics::ArbiterType Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ArbiterType.hx",193,0xeb73a8ef)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::dynamics::ArbiterType Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ArbiterType.hx",194,0xeb73a8ef)
					{
						HX_STACK_LINE(194)
