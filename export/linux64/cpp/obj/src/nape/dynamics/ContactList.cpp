...
::nape::dynamics::Contact ContactList_obj::at( int index){
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::ContactList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",370,0xd6cc37f4)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
::nape::dynamics::Contact ContactList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::ContactList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",498,0xd6cc37f4)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
::nape::dynamics::Contact ContactList_obj::shift( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::ContactList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",533,0xd6cc37f4)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
bool ContactList_obj::empty( ){
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::ContactList_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",632,0xd6cc37f4)
			{
				HX_STACK_LINE(632)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(632)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((_Function_2_1::Block(_g))){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::dynamics::Contact(_Function_3_1::Block()) : ::nape::dynamics::Contact(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::dynamics::Contact Block( ::nape::dynamics::ContactIterator &it){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",739,0xd6cc37f4)
					{
						HX_STACK_LINE(739)
...
::nape::dynamics::ContactList ContactList_obj::filter( Dynamic lambda){
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::ContactList_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",784,0xd6cc37f4)
			{
				HX_STACK_LINE(784)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(784)
