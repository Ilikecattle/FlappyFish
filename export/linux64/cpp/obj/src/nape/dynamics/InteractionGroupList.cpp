...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::at( int index){
	...
	HX_STACK_LINE(368)
	if (((  ((!(((index < (int)0))))) ? bool((index >= _Function_1_1::Block(this))) : bool(true) ))){
		HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/InteractionGroupList.hx",370,0x068b827f)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/InteractionGroupList.hx",428,0x068b827f)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/InteractionGroupList.hx",458,0x068b827f)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/InteractionGroupList.hx",498,0x068b827f)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::shift( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/InteractionGroupList.hx",533,0x068b827f)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((_Function_2_1::Block(_g))){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::dynamics::InteractionGroup(_Function_3_1::Block()) : ::nape::dynamics::InteractionGroup(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
...
::String InteractionGroupList_obj::toString( ){
	...
	HX_STACK_LINE(705)
	{
		...
		while((_Function_2_1::Block(_g))){
			...
			if (((i == null()))){
				HX_STACK_LINE(707)
				hx::AddEq(ret,HX_CSTRING("NULL"));
			}
			else{
				HX_STACK_LINE(707)
				hx::AddEq(ret,i->toString());
			}
			HX_STACK_LINE(708)
			fst = false;
		}
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::dynamics::InteractionGroup Block( ::nape::dynamics::InteractionGroupIterator &it){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/InteractionGroupList.hx",739,0x068b827f)
					{
						HX_STACK_LINE(739)
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::filter( Dynamic lambda){
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/InteractionGroupList.hx",784,0x068b827f)
			{
				HX_STACK_LINE(784)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(784)
