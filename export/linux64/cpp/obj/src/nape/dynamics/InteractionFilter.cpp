...
::String InteractionFilter_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(452)
	::String _g = ((HX_CSTRING("{ collision: ") + ::StringTools_obj::hex(this->zpp_inner->collisionGroup,(int)8)) + HX_CSTRING("~"));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(452)
	::String _g1 = ((_g + ::StringTools_obj::hex(this->zpp_inner->collisionMask,(int)8)) + HX_CSTRING(" sensor: "));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(452)
	::String _g2 = ((_g1 + ::StringTools_obj::hex(this->zpp_inner->sensorGroup,(int)8)) + HX_CSTRING("~"));		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(452)
	::String _g3 = ((_g2 + ::StringTools_obj::hex(this->zpp_inner->sensorMask,(int)8)) + HX_CSTRING(" fluid: "));		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(452)
	::String _g4 = ((_g3 + ::StringTools_obj::hex(this->zpp_inner->fluidGroup,(int)8)) + HX_CSTRING("~"));		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(452)
	return ((_g4 + ::StringTools_obj::hex(this->zpp_inner->fluidMask,(int)8)) + HX_CSTRING(" }"));
}
