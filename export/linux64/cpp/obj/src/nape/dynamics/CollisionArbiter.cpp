...
::nape::shape::Edge CollisionArbiter_obj::get_referenceEdge1( ){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::dynamics::CollisionArbiter_obj *__this,::zpp_nape::shape::ZPP_Edge &edge){
	...
	HX_STACK_ARG(freshOnly,"freshOnly")
{
		...
		HX_STACK_LINE(305)
		if (((  (((  (((body != null()))) ? bool((body != _Function_1_1::Block(this))) : bool(false) ))) ? bool((body != _Function_1_2::Block(this))) : bool(false) ))){
			HX_STACK_LINE(305)
		...
		if (((bool(!(freshOnly)) || bool(colarb->oc1->fresh)))){
			...
			HX_STACK_LINE(330)
			{
				...
				HX_STACK_LINE(332)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",342,0xb8178f73)
							{
								HX_STACK_LINE(342)
					...
					struct _Function_4_2{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",343,0xb8178f73)
							{
								HX_STACK_LINE(343)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(343)
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &imp){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",345,0xb8178f73)
						{
							HX_STACK_LINE(345)
							if (((bool((imp != null())) && bool(imp->zpp_disp)))){
								HX_STACK_LINE(345)
				...
				HX_STACK_LINE(353)
				{
					...
					HX_STACK_LINE(355)
					{
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",365,0xb8178f73)
								{
									HX_STACK_LINE(365)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(365)
						...
						struct _Function_5_2{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",366,0xb8178f73)
								{
									HX_STACK_LINE(366)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(366)
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",368,0xb8178f73)
							{
								HX_STACK_LINE(368)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(368)
		...
		if (((bool(!(freshOnly)) || bool(colarb->oc1->fresh)))){
			...
			HX_STACK_LINE(424)
			{
				...
				HX_STACK_LINE(426)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",436,0xb8178f73)
							{
								HX_STACK_LINE(436)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(436)
					...
					struct _Function_4_2{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",437,0xb8178f73)
							{
								HX_STACK_LINE(437)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(437)
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &imp){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",439,0xb8178f73)
						{
							HX_STACK_LINE(439)
							if (((bool((imp != null())) && bool(imp->zpp_disp)))){
								HX_STACK_LINE(439)
			...
			if (((bool(!(freshOnly)) || bool(colarb->oc2->fresh)))){
				...
				HX_STACK_LINE(447)
				{
					...
					HX_STACK_LINE(449)
					{
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",459,0xb8178f73)
								{
									HX_STACK_LINE(459)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(459)
						...
						struct _Function_5_2{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",460,0xb8178f73)
								{
									HX_STACK_LINE(460)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(460)
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",462,0xb8178f73)
							{
								HX_STACK_LINE(462)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(462)
		...
		if (((bool(!(freshOnly)) || bool(colarb->oc1->fresh)))){
			...
			HX_STACK_LINE(515)
			{
				...
				HX_STACK_LINE(517)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",527,0xb8178f73)
							{
								HX_STACK_LINE(527)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(527)
					...
					struct _Function_4_2{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",528,0xb8178f73)
							{
								HX_STACK_LINE(528)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(528)
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &imp){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",530,0xb8178f73)
						{
							HX_STACK_LINE(530)
							if (((bool((imp != null())) && bool(imp->zpp_disp)))){
								HX_STACK_LINE(530)
			...
			if (((bool(!(freshOnly)) || bool(colarb->oc2->fresh)))){
				...
				HX_STACK_LINE(538)
				{
					...
					HX_STACK_LINE(540)
					{
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",550,0xb8178f73)
								{
									HX_STACK_LINE(550)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(550)
						...
						struct _Function_5_2{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",551,0xb8178f73)
								{
									HX_STACK_LINE(551)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(551)
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/CollisionArbiter.hx",553,0xb8178f73)
							{
								HX_STACK_LINE(553)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(553)
