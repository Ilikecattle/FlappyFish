...
bool ArbiterList_obj::empty( ){
	HX_STACK_FRAME("nape.dynamics.ArbiterList","empty",0x7919f292,"nape.dynamics.ArbiterList.empty","nape/dynamics/ArbiterList.hx",634,0xfd301dcb)
	HX_STACK_THIS(this)
	HX_STACK_LINE(634)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((_Function_2_1::Block(_g))){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::dynamics::Arbiter(_Function_3_1::Block()) : ::nape::dynamics::Arbiter(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::dynamics::Arbiter Block( ::nape::dynamics::ArbiterIterator &it){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ArbiterList.hx",739,0xfd301dcb)
					{
						HX_STACK_LINE(739)
