...
::String Arbiter_obj::toString( ){
	...
	if ((this->zpp_inner->cleared)){
		...
		HX_STACK_LINE(379)
		::String _g = (((ret + HX_CSTRING("(")) + (_Function_2_1::Block(this))->toString()) + HX_CSTRING("|"));		HX_STACK_VAR(_g,"_g");
		...
		HX_STACK_LINE(379)
		::String _g1 = ((_g + (_Function_2_2::Block(this))->toString()) + HX_CSTRING(")"));		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(379)
		::String _g3;		HX_STACK_VAR(_g3,"_g3");
		struct _Function_2_3{
			inline static ::String Block( ::nape::dynamics::Arbiter_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/Arbiter.hx",379,0x42fd8209)
				{
					HX_STACK_LINE(379)
					int _g2;		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(379)
					if ((__this->zpp_inner->colarb->stat)){
						HX_STACK_LINE(379)
						_g2 = (int)0;
					}
					else{
					...
					HX_STACK_LINE(379)
					return ((HX_CSTRING("[") + Array_obj< ::String >::__new().Add(HX_CSTRING("SD")).Add(HX_CSTRING("DD"))->__get(_g2)) + HX_CSTRING("]"));
				}
				return null();
			}
		};
		HX_STACK_LINE(379)
		_g3 = ((_g1 + ((  (((this->zpp_inner->type == ::zpp_nape::dynamics::ZPP_Arbiter_obj::COL))) ? ::String(_Function_2_3::Block(this)) : ::String(HX_CSTRING("")) ))) + HX_CSTRING("<-"));
				...
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/Arbiter.hx",379,0x42fd8209)
				{
					...
					struct _Function_3_1{
						inline static ::nape::callbacks::PreFlag Block( ::nape::dynamics::Arbiter_obj *__this){
							...
							{
								HX_STACK_LINE(379)
								int _g2 = __this->zpp_inner->immState;		HX_STACK_VAR(_g2,"_g2");
								struct _Function_4_1{
									inline static ::nape::callbacks::PreFlag Block( int &_g2){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/Arbiter.hx",379,0x42fd8209)
										{
											HX_STACK_LINE(379)
											...
											struct _Function_5_2{
												inline static ::nape::callbacks::PreFlag Block( int &_g2){
													...
													{
														HX_STACK_LINE(379)
														int x1 = _g2;		HX_STACK_VAR(x1,"x1");
														struct _Function_6_1{
															inline static ::nape::callbacks::PreFlag Block( int &x1,int &_g2){
																HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/Arbiter.hx",379,0x42fd8209)
																{
																	HX_STACK_LINE(379)
																	int _switch_2 = (_g2);
...
;
														...
														HX_STACK_LINE(379)
														return _Function_6_1::Block(x1,_g2);
													}
													return null();
												}
											};
											HX_STACK_LINE(379)
											return (  (((x == ((int(::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ACCEPT) | int(::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ALWAYS)))))) ? ::nape::callbacks::PreFlag(_Function_5_1::Block()) : ::nape::callbacks::PreFlag(_Function_5_2::Block(_g2)) );
										}
										return null();
									}
								};
								HX_STACK_LINE(379)
								return _Function_4_1::Block(_g2);
							}
							return null();
						}
					};
		...
		HX_STACK_LINE(379)
		return (_g3 + (_Function_2_4::Block(this))->toString());
	}
	HX_STACK_LINE(378)
	return null();
}
