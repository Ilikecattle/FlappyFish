...
::String Broadphase_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::space::Broadphase Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/space/Broadphase.hx",192,0xebaaca55)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::space::Broadphase Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/space/Broadphase.hx",193,0xebaaca55)
				{
					HX_STACK_LINE(193)
