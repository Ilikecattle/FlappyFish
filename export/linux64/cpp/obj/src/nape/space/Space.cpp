...
::nape::callbacks::InteractionType Space_obj::interactionType( ::nape::shape::Shape shape1,::nape::shape::Shape shape2){
	...
	HX_STACK_LINE(583)
	if (((shape1->zpp_inner->body != null()))){
		HX_STACK_LINE(583)
		_g = shape1->zpp_inner->body->outer;
	}
	else{
		HX_STACK_LINE(583)
		_g = null();
	...
	HX_STACK_LINE(583)
	if (((bool((_g == null())) || bool((((  (((shape2->zpp_inner->body != null()))) ? ::nape::phys::Body(shape2->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))))){
		HX_STACK_LINE(583)
	...
	if (((shape1->zpp_inner->body != null()))){
		HX_STACK_LINE(585)
		_g1 = shape1->zpp_inner->body->outer;
	}
	else{
		HX_STACK_LINE(585)
		_g1 = null();
	...
	HX_STACK_LINE(585)
	if (((bool((_g1->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_STATIC)) && bool((((  (((shape2->zpp_inner->body != null()))) ? ::nape::phys::Body(shape2->zpp_inner->body->outer) : ::nape::phys::Body(null()) ))->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_STATIC))))){
		HX_STACK_LINE(585)
		return null();
	}
	HX_STACK_LINE(586)
	...
	if (((shape1->zpp_inner->body != null()))){
		HX_STACK_LINE(586)
		_g2 = shape1->zpp_inner->body->outer;
	}
	else{
		HX_STACK_LINE(586)
		_g2 = null();
	...
	HX_STACK_LINE(586)
	if (((_g2 == ((  (((shape2->zpp_inner->body != null()))) ? ::nape::phys::Body(shape2->zpp_inner->body->outer) : ::nape::phys::Body(null()) ))))){
		HX_STACK_LINE(586)
		return null();
	}
	HX_STACK_LINE(587)
	...
	HX_STACK_ARG(output,"output")
{
		...
		HX_STACK_LINE(693)
		if (((  ((!(((_Function_1_1::Block(aabb) == (int)0))))) ? bool((_Function_1_2::Block(aabb) == (int)0)) : bool(true) ))){
			HX_STACK_LINE(693)
		...
		if (((shape->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON))){
			...
			struct _Function_2_1{
				inline static ::nape::shape::ValidationResult Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/space/Space.hx",844,0x769bc808)
					{
						HX_STACK_LINE(844)
	...
	HX_STACK_ARG(output,"output")
{
		...
		if (((shape->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON))){
			...
			struct _Function_2_1{
				inline static ::nape::shape::ValidationResult Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/space/Space.hx",876,0x769bc808)
					{
						HX_STACK_LINE(876)
						if (((::zpp_nape::util::ZPP_Flags_obj::ValidationResult_VALID == null()))){
							HX_STACK_LINE(876)
