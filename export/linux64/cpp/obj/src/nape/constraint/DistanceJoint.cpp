...
bool DistanceJoint_obj::isSlack( ){
	...
	HX_STACK_LINE(384)
	if (((bool((_g == null())) || bool((((  (((this->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b2->outer) )) == null()))))){
		HX_STACK_LINE(385)
...
::nape::geom::Vec3 DistanceJoint_obj::bodyImpulse( ::nape::phys::Body body){
	...
	HX_STACK_LINE(442)
	if (((bool((body != _g)) && bool((body != ((  (((this->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b2->outer) ))))))){
		HX_STACK_LINE(443)
