...
::nape::shape::Edge EdgeList_obj::at( int index){
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::shape::EdgeList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/EdgeList.hx",370,0x6c4938ee)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::shape::EdgeList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/EdgeList.hx",428,0x6c4938ee)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::shape::EdgeList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/EdgeList.hx",458,0x6c4938ee)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
::nape::shape::Edge EdgeList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::EdgeList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/EdgeList.hx",498,0x6c4938ee)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
::nape::shape::Edge EdgeList_obj::shift( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::EdgeList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/EdgeList.hx",533,0x6c4938ee)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((_Function_2_1::Block(_g))){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::shape::Edge(_Function_3_1::Block()) : ::nape::shape::Edge(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::shape::Edge Block( ::nape::shape::EdgeIterator &it){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/EdgeList.hx",739,0x6c4938ee)
					{
						HX_STACK_LINE(739)
...
::nape::shape::EdgeList EdgeList_obj::filter( Dynamic lambda){
	...
	struct _Function_1_1{
		inline static int Block( ::nape::shape::EdgeList_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/EdgeList.hx",784,0x6c4938ee)
			{
				HX_STACK_LINE(784)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(784)
