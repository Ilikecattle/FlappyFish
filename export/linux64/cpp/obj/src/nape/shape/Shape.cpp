	...
	if (((translation->lsq() > (int)0))){
		...
		if (((this->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
			...
			HX_STACK_LINE(499)
			{
				...
				HX_STACK_LINE(499)
				_g = translation->zpp_inner->x;
			}
			struct _Function_3_1{
				inline static Float Block( ::nape::geom::Vec2 &translation){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/Shape.hx",499,0x036d22d2)
					{
						HX_STACK_LINE(499)
						if (((bool((translation != null())) && bool(translation->zpp_disp)))){
							HX_STACK_LINE(499)
			...
			HX_STACK_LINE(499)
			this->zpp_inner->circle->__translate(_g,_Function_3_1::Block(translation));
		}
		else{
			HX_STACK_LINE(500)
			...
			struct _Function_3_1{
				inline static Float Block( ::nape::geom::Vec2 &translation){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/Shape.hx",500,0x036d22d2)
					{
						HX_STACK_LINE(500)
						if (((bool((translation != null())) && bool(translation->zpp_disp)))){
							HX_STACK_LINE(500)
			...
			HX_STACK_LINE(500)
			this->zpp_inner->polygon->__translate(_g1,_Function_3_1::Block(translation));
		}
	}
	HX_STACK_LINE(502)
