...
::String ShapeType_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::shape::ShapeType Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeType.hx",192,0xe7bde238)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::shape::ShapeType Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeType.hx",193,0xe7bde238)
				{
					HX_STACK_LINE(193)
