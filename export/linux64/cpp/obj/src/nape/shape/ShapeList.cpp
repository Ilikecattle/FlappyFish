...
::nape::shape::Shape ShapeList_obj::at( int index){
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeList.hx",370,0xf97a5714)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::shape::ShapeList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeList.hx",428,0xf97a5714)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::shape::ShapeList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeList.hx",458,0xf97a5714)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
::nape::shape::Shape ShapeList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeList.hx",498,0xf97a5714)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
::nape::shape::Shape ShapeList_obj::shift( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeList.hx",533,0xf97a5714)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((_Function_2_1::Block(_g))){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::shape::Shape(_Function_3_1::Block()) : ::nape::shape::Shape(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::shape::Shape Block( ::nape::shape::ShapeIterator &it){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeList.hx",739,0xf97a5714)
					{
						HX_STACK_LINE(739)
...
::nape::shape::ShapeList ShapeList_obj::filter( Dynamic lambda){
	...
	struct _Function_1_1{
		inline static int Block( ::nape::shape::ShapeList_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/shape/ShapeList.hx",784,0xf97a5714)
			{
				HX_STACK_LINE(784)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(784)
