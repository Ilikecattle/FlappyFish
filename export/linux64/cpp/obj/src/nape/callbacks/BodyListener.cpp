...
int precedence = __o_precedence.Default(0);
{
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::CbEvent Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/BodyListener.hx",262,0x83186dc0)
			{
				HX_STACK_LINE(262)
	...
	if (((event == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::CbEvent Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/BodyListener.hx",263,0x83186dc0)
				{
					HX_STACK_LINE(263)
