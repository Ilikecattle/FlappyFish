...
::String InteractionType_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::InteractionType Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionType.hx",192,0xf2de5b1a)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::InteractionType Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionType.hx",193,0xf2de5b1a)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::InteractionType Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionType.hx",194,0xf2de5b1a)
					{
						HX_STACK_LINE(194)
			...
			if (((hx::ObjectPtr<OBJ_>(this) == _Function_3_1::Block()))){
				...
				struct _Function_4_1{
					inline static ::nape::callbacks::InteractionType Block( ){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionType.hx",195,0xf2de5b1a)
						{
							HX_STACK_LINE(195)
