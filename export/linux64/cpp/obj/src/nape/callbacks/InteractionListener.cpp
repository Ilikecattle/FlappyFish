...
int precedence = __o_precedence.Default(0);
{
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::CbEvent Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionListener.hx",355,0xa06240a0)
			{
				HX_STACK_LINE(355)
	...
	if (((event == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::CbEvent Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionListener.hx",356,0xa06240a0)
				{
					HX_STACK_LINE(356)
		...
		if (((event == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::CbEvent Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionListener.hx",357,0xa06240a0)
					{
						HX_STACK_LINE(357)
	...
	HX_STACK_LINE(363)
	this->zpp_inner_zn = ::zpp_nape::callbacks::ZPP_InteractionListener_obj::__new(_g,::zpp_nape::callbacks::ZPP_OptionType_obj::argument(options2),xevent,::zpp_nape::util::ZPP_Flags_obj::id_ListenerType_INTERACTION);
	HX_STACK_LINE(364)
		...
		HX_STACK_LINE(369)
		{
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::InteractionType Block( ::nape::callbacks::InteractionListener_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionListener.hx",369,0xa06240a0)
					{
						HX_STACK_LINE(369)
...
::nape::callbacks::InteractionType InteractionListener_obj::set_interactionType( ::nape::callbacks::InteractionType interactionType){
	...
	HX_STACK_LINE(258)
	{
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::InteractionType Block( ::nape::callbacks::InteractionListener_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionListener.hx",264,0xa06240a0)
				{
					HX_STACK_LINE(264)
					int ret = __this->zpp_inner_zn->itype;		HX_STACK_VAR(ret,"ret");
					struct _Function_3_1{
		...
		if (((_Function_2_1::Block(this) != interactionType))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::InteractionType Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/callbacks/InteractionListener.hx",265,0xa06240a0)
					{
						HX_STACK_LINE(265)
						if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION == null()))){
							HX_STACK_LINE(265)
