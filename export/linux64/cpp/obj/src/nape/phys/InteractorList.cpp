...
::nape::phys::Interactor InteractorList_obj::at( int index){
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::phys::InteractorList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",370,0x3e1b3871)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::InteractorList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",428,0x3e1b3871)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::InteractorList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",458,0x3e1b3871)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
::nape::phys::Interactor InteractorList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::InteractorList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",498,0x3e1b3871)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
::nape::phys::Interactor InteractorList_obj::shift( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::InteractorList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",533,0x3e1b3871)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((_Function_2_1::Block(_g))){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::phys::Interactor(_Function_3_1::Block()) : ::nape::phys::Interactor(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::phys::Interactor Block( ::nape::phys::InteractorIterator &it){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",739,0x3e1b3871)
					{
						HX_STACK_LINE(739)
...
::nape::phys::InteractorList InteractorList_obj::filter( Dynamic lambda){
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::InteractorList_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/InteractorList.hx",784,0x3e1b3871)
			{
				HX_STACK_LINE(784)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(784)
