...
::nape::phys::Material Material_obj::copy( ){
	...
	HX_STACK_LINE(265)
	int _g3 = (int)1000;		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(265)
	::nape::phys::Material ret = ::nape::phys::Material_obj::__new((this->zpp_inner->elasticity * _g),(this->zpp_inner->dynamicFriction * _g1),(this->zpp_inner->staticFriction * _g2),(this->zpp_inner->density * _g3),this->zpp_inner->rollingFriction);		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(266)
	if (((this->zpp_inner->userData != null()))){
		HX_STACK_LINE(266)
...
::String Material_obj::toString( ){
	...
	int _g1 = (int)1;		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(426)
	int _g2 = (int)1000;		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(426)
	int _g3 = (int)1;		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(426)
	return ((((((((((HX_CSTRING("{ elasticity: ") + this->zpp_inner->elasticity) + HX_CSTRING(" dynamicFriction: ")) + (this->zpp_inner->dynamicFriction * _g)) + HX_CSTRING(" staticFriction: ")) + (this->zpp_inner->staticFriction * _g1)) + HX_CSTRING(" density: ")) + (this->zpp_inner->density * _g2)) + HX_CSTRING(" rollingFriction: ")) + (this->zpp_inner->rollingFriction * _g3)) + HX_CSTRING(" }"));
}
