...
::String BodyType_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::phys::BodyType Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyType.hx",192,0x8b4ddeec)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::phys::BodyType Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyType.hx",193,0x8b4ddeec)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::phys::BodyType Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyType.hx",194,0x8b4ddeec)
					{
						HX_STACK_LINE(194)
