			...
			inline static ::nape::geom::Vec2 Block( bool &weak){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/Compound.hx",402,0x15c2ad5d)
				{
					...
					if (((ret->zpp_inner == null()))){
						...
						HX_STACK_LINE(402)
						if ((!(((  (((_Function_3_1::Block(ret) == (int)0))) ? bool((_Function_3_2::Block(ret) == (int)0)) : bool(false) ))))){
							HX_STACK_LINE(402)
							{
								HX_STACK_LINE(402)
								...
								if (((b->zpp_inner->wrap_worldCOM == null()))){
									HX_STACK_LINE(406)
									{
										...
										if (((ret1->zpp_inner == null()))){
											...
											HX_STACK_LINE(406)
											if ((!(((  (((_Function_7_1::Block(ret1) == x))) ? bool((_Function_7_2::Block(ret1) == y)) : bool(false) ))))){
												HX_STACK_LINE(406)
												{
													HX_STACK_LINE(406)
													ret1->zpp_inner->x = x;
