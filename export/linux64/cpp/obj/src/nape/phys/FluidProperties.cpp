...
::nape::phys::FluidProperties FluidProperties_obj::copy( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(255)
	int _g = (int)1000;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(255)
	::nape::phys::FluidProperties ret = ::nape::phys::FluidProperties_obj::__new((this->zpp_inner->density * _g),this->zpp_inner->viscosity);		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(256)
	if (((this->zpp_inner->userData != null()))){
		HX_STACK_LINE(256)
...
::String FluidProperties_obj::toString( ){
	...
	HX_STACK_LINE(345)
	return ((((((HX_CSTRING("{ density: ") + (this->zpp_inner->density * _g)) + HX_CSTRING(" viscosity: ")) + (this->zpp_inner->viscosity * _g1)) + HX_CSTRING(" gravity: ")) + ::Std_obj::string(this->zpp_inner->wrap_gravity)) + HX_CSTRING(" }"));
}
