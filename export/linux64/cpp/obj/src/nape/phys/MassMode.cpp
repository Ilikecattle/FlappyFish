...
::String MassMode_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::phys::MassMode Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/MassMode.hx",192,0x8a4995d1)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::phys::MassMode Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/MassMode.hx",193,0x8a4995d1)
				{
					HX_STACK_LINE(193)
