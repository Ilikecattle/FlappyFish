...
::nape::phys::Body BodyList_obj::at( int index){
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",370,0x9d0a53c8)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::BodyList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",428,0x9d0a53c8)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::BodyList_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",458,0x9d0a53c8)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
::nape::phys::Body BodyList_obj::pop( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",498,0x9d0a53c8)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
::nape::phys::Body BodyList_obj::shift( ){
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",533,0x9d0a53c8)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((_Function_2_1::Block(_g))){
				...
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::phys::Body(_Function_3_1::Block()) : ::nape::phys::Body(i) ));
			}
		}
		HX_STACK_LINE(671)
		return ret;
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::phys::Body Block( ::nape::phys::BodyIterator &it){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",739,0x9d0a53c8)
					{
						HX_STACK_LINE(739)
...
::nape::phys::BodyList BodyList_obj::filter( Dynamic lambda){
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::BodyList_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/BodyList.hx",784,0x9d0a53c8)
			{
				HX_STACK_LINE(784)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(784)
