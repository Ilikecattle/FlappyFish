	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if ((noTranslation)){
			...
			HX_STACK_LINE(661)
			_g = (_Function_2_1::Block(point) * this->zpp_inner->a);
			HX_STACK_LINE(661)
			...
			HX_STACK_LINE(661)
			x = (_g + (_Function_2_2::Block(point) * this->zpp_inner->b));
			HX_STACK_LINE(661)
			...
			HX_STACK_LINE(661)
			_g1 = (_Function_2_3::Block(point) * this->zpp_inner->c);
			HX_STACK_LINE(661)
			...
			HX_STACK_LINE(661)
			y = (_g1 + (_Function_2_4::Block(point) * this->zpp_inner->d));
			HX_STACK_LINE(661)
			...
			HX_STACK_LINE(664)
			_g2 = (_Function_2_1::Block(point) * this->zpp_inner->a);
			HX_STACK_LINE(664)
			Float x;		HX_STACK_VAR(x,"x");
			struct _Function_2_2{
				inline static Float Block( ::nape::geom::Vec2 &point){
			...
			HX_STACK_LINE(664)
			x = ((_g2 + (_Function_2_2::Block(point) * this->zpp_inner->b)) + this->zpp_inner->tx);
			HX_STACK_LINE(664)
			...
			HX_STACK_LINE(664)
			_g3 = (_Function_2_3::Block(point) * this->zpp_inner->c);
			HX_STACK_LINE(664)
			Float y;		HX_STACK_VAR(y,"y");
			struct _Function_2_4{
				inline static Float Block( ::nape::geom::Vec2 &point){
			...
			HX_STACK_LINE(664)
			y = ((_g3 + (_Function_2_4::Block(point) * this->zpp_inner->d)) + this->zpp_inner->ty);
			HX_STACK_LINE(664)
			if (((bool((x != x)) || bool((y != y))))){
				HX_STACK_LINE(664)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 components cannot be NaN"));
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if ((noTranslation)){
			...
			HX_STACK_LINE(719)
			_g = (_Function_2_1::Block(point) * this->zpp_inner->d);
			HX_STACK_LINE(719)
			Float x;		HX_STACK_VAR(x,"x");
			struct _Function_2_2{
				inline static Float Block( ::nape::geom::Vec2 &point){
			...
			HX_STACK_LINE(719)
			x = (((_g - (_Function_2_2::Block(point) * this->zpp_inner->b))) * idet);
			HX_STACK_LINE(719)
			Float _g1;		HX_STACK_VAR(_g1,"_g1");
			struct _Function_2_3{
				inline static Float Block( ::nape::geom::Vec2 &point){
			...
			HX_STACK_LINE(719)
			_g1 = (_Function_2_3::Block(point) * this->zpp_inner->a);
			HX_STACK_LINE(719)
			Float y;		HX_STACK_VAR(y,"y");
			struct _Function_2_4{
				inline static Float Block( ::nape::geom::Vec2 &point){
			...
			HX_STACK_LINE(719)
			y = (((_g1 - (_Function_2_4::Block(point) * this->zpp_inner->c))) * idet);
			HX_STACK_LINE(719)
			if (((bool((x != x)) || bool((y != y))))){
				HX_STACK_LINE(719)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 components cannot be NaN"));
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &point){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Mat23.hx",722,0xee046d69)
					{
						HX_STACK_LINE(722)
						if (((bool((point != null())) && bool(point->zpp_disp)))){
							HX_STACK_LINE(722)
			...
			struct _Function_2_2{
				inline static Float Block( ::nape::geom::Vec2 &point){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Mat23.hx",723,0xee046d69)
					{
						HX_STACK_LINE(723)
						if (((bool((point != null())) && bool(point->zpp_disp)))){
							HX_STACK_LINE(723)
			...
			HX_STACK_LINE(724)
			{
				...
				if (((ret1->zpp_inner == null()))){
					...
					HX_STACK_LINE(724)
					if ((!(((  (((_Function_4_1::Block(ret1) == x))) ? bool((_Function_4_2::Block(ret1) == y)) : bool(false) ))))){
						HX_STACK_LINE(724)
						{
							HX_STACK_LINE(724)
							ret1->zpp_inner->x = x;
