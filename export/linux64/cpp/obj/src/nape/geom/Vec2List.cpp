...
::nape::geom::Vec2 Vec2List_obj::at( int index){
	...
	this->zpp_vm();
	HX_STACK_LINE(368)
	if (((  ((!(((index < (int)0))))) ? bool((index >= this->zpp_gl())) : bool(true) ))){
		HX_STACK_LINE(368)
...
bool Vec2List_obj::empty( ){
	HX_STACK_FRAME("nape.geom.Vec2List","empty",0x98e80287,"nape.geom.Vec2List.empty","nape/geom/Vec2List.hx",634,0x7ea67276)
	HX_STACK_THIS(this)
	HX_STACK_LINE(634)
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::geom::Vec2 &i){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2List.hx",664,0x7ea67276)
						{
								...
								inline static ::nape::geom::Vec2 Block( ::nape::geom::Vec2 &i,bool &weak){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2List.hx",664,0x7ea67276)
									{
										...
										if (((ret1->zpp_inner == null()))){
											...
											HX_STACK_LINE(664)
											if ((!(((  (((_Function_6_1::Block(ret1) == x))) ? bool((_Function_6_2::Block(ret1) == y)) : bool(false) ))))){
												HX_STACK_LINE(664)
												{
													HX_STACK_LINE(664)
													ret1->zpp_inner->x = x;
							...
							HX_STACK_LINE(664)
							return _Function_4_1::Block(i,weak);
						}
						return null();
					}
				};
				HX_STACK_LINE(664)
				ret->push((  ((deep)) ? ::nape::geom::Vec2(_Function_3_1::Block(i)) : ::nape::geom::Vec2(i) ));
			}
		}
		HX_STACK_LINE(665)
		return ret;
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::geom::Vec2 Block( ::nape::geom::Vec2Iterator &it){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2List.hx",733,0x7ea67276)
					{
						HX_STACK_LINE(733)
