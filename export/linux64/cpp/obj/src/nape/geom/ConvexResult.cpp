...
::String ConvexResult_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::shape::Shape Block( ::nape::geom::ConvexResult_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/ConvexResult.hx",256,0x8636d4ae)
			{
				HX_STACK_LINE(256)
	...
	HX_STACK_LINE(256)
	::String _g = ((HX_CSTRING("{ shape: ") + ::Std_obj::string(_Function_1_1::Block(this))) + HX_CSTRING(" toi: "));		HX_STACK_VAR(_g,"_g");
	...
	HX_STACK_LINE(256)
	return ((_g + _Function_1_2::Block(this)) + HX_CSTRING(" }"));
}
