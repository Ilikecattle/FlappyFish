...
::String RayResult_obj::toString( ){
	...
	struct _Function_1_1{
		inline static ::nape::shape::Shape Block( ::nape::geom::RayResult_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/RayResult.hx",256,0xc2787b23)
			{
				HX_STACK_LINE(256)
	...
	HX_STACK_LINE(256)
	::String _g = ((HX_CSTRING("{ shape: ") + ::Std_obj::string(_Function_1_1::Block(this))) + HX_CSTRING(" distance: "));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(256)
	...
	HX_STACK_LINE(256)
	_g1 = ((_g + _Function_1_2::Block(this)) + HX_CSTRING(" ?inner: "));
	...
	HX_STACK_LINE(256)
	return ((_g1 + ::Std_obj::string(_Function_1_3::Block(this))) + HX_CSTRING(" }"));
}
