	...
	HX_STACK_LINE(533)
	{
		...
		struct _Function_2_1{
			inline static Float Block( ::nape::geom::Vec2_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",540,0x020b6534)
				{
					HX_STACK_LINE(540)
					if ((__this->zpp_disp)){
						HX_STACK_LINE(540)
...
Float Vec2_obj::set_y( Float y){
	...
	HX_STACK_LINE(569)
	{
		...
		struct _Function_2_1{
			inline static Float Block( ::nape::geom::Vec2_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",576,0x020b6534)
				{
					HX_STACK_LINE(576)
					if ((__this->zpp_disp)){
						HX_STACK_LINE(576)
...
Float Vec2_obj::get_length( ){
	...
	struct _Function_1_1{
		inline static Float Block( ::nape::geom::Vec2_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",605,0x020b6534)
			{
				HX_STACK_LINE(605)
				if ((__this->zpp_disp)){
					HX_STACK_LINE(605)
	...
	HX_STACK_LINE(605)
	_g1 = (_g * _Function_1_1::Block(this));
	HX_STACK_LINE(605)
	...
	HX_STACK_LINE(605)
	return ::Math_obj::sqrt((_g1 + (_g2 * _Function_1_2::Block(this))));
}
...
Float Vec2_obj::set_length( Float length){
	...
	HX_STACK_LINE(608)
	{
		...
		struct _Function_2_1{
			inline static Float Block( ::nape::geom::Vec2_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",619,0x020b6534)
				{
					HX_STACK_LINE(619)
					if ((__this->zpp_disp)){
						HX_STACK_LINE(619)
		...
		HX_STACK_LINE(619)
		_g1 = (_g * _Function_2_1::Block(this));
		HX_STACK_LINE(619)
		Float _g2;		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(619)
		{
		...
		HX_STACK_LINE(619)
		if ((((_g1 + (_g2 * _Function_2_2::Block(this))) == (int)0))){
			HX_STACK_LINE(620)
		...
		HX_STACK_LINE(623)
		{
			...
			HX_STACK_LINE(624)
			{
				...
				HX_STACK_LINE(624)
				_g3 = this->zpp_inner->x;
			}
			HX_STACK_LINE(624)
			Float _g4;		HX_STACK_VAR(_g4,"_g4");
			struct _Function_3_1{
				inline static Float Block( ::nape::geom::Vec2_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",624,0x020b6534)
					{
						HX_STACK_LINE(624)
						if ((__this->zpp_disp)){
							HX_STACK_LINE(624)
			...
			HX_STACK_LINE(624)
			_g4 = (_g3 * _Function_3_1::Block(this));
			HX_STACK_LINE(624)
			...
			HX_STACK_LINE(624)
			Float t = (Float(length) / Float(::Math_obj::sqrt((_g4 + (_g5 * _Function_3_2::Block(this))))));		HX_STACK_VAR(t,"t");
			HX_STACK_LINE(633)
			{
				HX_STACK_LINE(633)
				::nape::geom::Vec2 _g6 = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g6,"_g6");
				HX_STACK_LINE(633)
				{
					HX_STACK_LINE(633)
					Float x;		HX_STACK_VAR(x,"x");
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 &_g6){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",633,0x020b6534)
							{
								HX_STACK_LINE(633)
								if (((bool((_g6 != null())) && bool(_g6->zpp_disp)))){
									HX_STACK_LINE(633)
									HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 has been disposed and cannot be used!"));
								}
								HX_STACK_LINE(633)
								...
								HX_STACK_LINE(633)
								return _g6->zpp_inner->x;
							}
							return null();
						}
					};
					HX_STACK_LINE(633)
					x = (_Function_5_1::Block(_g6) * t);
					HX_STACK_LINE(633)
					{
						HX_STACK_LINE(633)
						if (((bool((_g6 != null())) && bool(_g6->zpp_disp)))){
			...
			HX_STACK_LINE(634)
			{
				...
				HX_STACK_LINE(634)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 &_g6){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",634,0x020b6534)
							{
								HX_STACK_LINE(634)
								if (((bool((_g6 != null())) && bool(_g6->zpp_disp)))){
									HX_STACK_LINE(634)
								...
								HX_STACK_LINE(634)
								return _g6->zpp_inner->y;
							}
							return null();
						}
					};
					HX_STACK_LINE(634)
					y = (_Function_5_1::Block(_g6) * t);
					HX_STACK_LINE(634)
					{
						HX_STACK_LINE(634)
						if (((bool((_g6 != null())) && bool(_g6->zpp_disp)))){
	...
	HX_STACK_LINE(638)
	{
		...
		HX_STACK_LINE(638)
		_g6 = this->zpp_inner->x;
	}
	HX_STACK_LINE(638)
	Float _g7;		HX_STACK_VAR(_g7,"_g7");
	struct _Function_1_1{
		inline static Float Block( ::nape::geom::Vec2_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",638,0x020b6534)
			{
				HX_STACK_LINE(638)
				if ((__this->zpp_disp)){
					HX_STACK_LINE(638)
	...
	HX_STACK_LINE(638)
	_g7 = (_g6 * _Function_1_1::Block(this));
	HX_STACK_LINE(638)
	...
	HX_STACK_LINE(638)
	return ::Math_obj::sqrt((_g7 + (_g8 * _Function_1_2::Block(this))));
}
...
Float Vec2_obj::lsq( ){
	...
	struct _Function_1_1{
		inline static Float Block( ::nape::geom::Vec2_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",656,0x020b6534)
			{
				HX_STACK_LINE(656)
				if ((__this->zpp_disp)){
					HX_STACK_LINE(656)
	...
	HX_STACK_LINE(656)
	return (_g1 + (_g2 * _Function_1_2::Block(this)));
}
...
::nape::geom::Vec2 Vec2_obj::set( ::nape::geom::Vec2 vector){
	...
	HX_STACK_LINE(688)
	{
		...
		HX_STACK_LINE(688)
		if ((!(((  (((_Function_2_1::Block(this) == x))) ? bool((_Function_2_2::Block(this) == y)) : bool(false) ))))){
			HX_STACK_LINE(688)
			{
				HX_STACK_LINE(688)
				this->zpp_inner->x = x;
...
::nape::geom::Vec2 Vec2_obj::setxy( Float x,Float y){
	...
	HX_STACK_LINE(820)
	if ((!(((  (((_Function_1_1::Block(this) == x))) ? bool((_Function_1_2::Block(this) == y)) : bool(false) ))))){
		HX_STACK_LINE(821)
		{
			HX_STACK_LINE(822)
			this->zpp_inner->x = x;
...
Float Vec2_obj::get_angle( ){
	...
	HX_STACK_LINE(867)
	if (((  (((_g == _Function_1_1::Block(this)))) ? bool((_Function_1_2::Block(this) == (int)0)) : bool(false) ))){
		HX_STACK_LINE(868)
		return 0.0;
	}
	else{
		...
		struct _Function_2_1{
			inline static Float Block( ::nape::geom::Vec2_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",871,0x020b6534)
				{
					HX_STACK_LINE(871)
					if ((__this->zpp_disp)){
						HX_STACK_LINE(871)
		...
		HX_STACK_LINE(871)
		return ::Math_obj::atan2(_g1,_Function_2_1::Block(this));
	}
	HX_STACK_LINE(867)
	return 0.;
}
...
Float Vec2_obj::set_angle( Float angle){
	...
	HX_STACK_LINE(875)
	{
		...
		HX_STACK_LINE(887)
		{
			...
			struct _Function_3_1{
				inline static Float Block( ::nape::geom::Vec2_obj *__this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",887,0x020b6534)
					{
						HX_STACK_LINE(887)
						if ((__this->zpp_disp)){
							HX_STACK_LINE(887)
			...
			HX_STACK_LINE(887)
			_g1 = (_g * _Function_3_1::Block(this));
			HX_STACK_LINE(887)
			Float _g2;		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(887)
			{
			...
			HX_STACK_LINE(887)
			l = ::Math_obj::sqrt((_g1 + (_g2 * _Function_3_2::Block(this))));
		}
		HX_STACK_LINE(888)
		{
			HX_STACK_LINE(888)
			...
			HX_STACK_LINE(888)
			if ((!(((  (((_Function_3_1::Block(this) == x))) ? bool((_Function_3_2::Block(this) == y)) : bool(false) ))))){
				HX_STACK_LINE(888)
				{
					HX_STACK_LINE(888)
					this->zpp_inner->x = x;
	...
	HX_STACK_LINE(890)
	if (((  (((_g3 == _Function_1_1::Block(this)))) ? bool((_Function_1_2::Block(this) == (int)0)) : bool(false) ))){
		HX_STACK_LINE(890)
		return 0.0;
	}
	else{
		...
		HX_STACK_LINE(890)
		return ::Math_obj::atan2(_g4,_Function_2_1::Block(this));
	}
	HX_STACK_LINE(890)
	return 0.;
}
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		struct _Function_1_1{
			inline static Float Block( ::nape::geom::Vec2_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",954,0x020b6534)
				{
					HX_STACK_LINE(954)
					if ((__this->zpp_disp)){
						HX_STACK_LINE(954)
					...
					HX_STACK_LINE(954)
					_g1 = (_g * _Function_2_1::Block(__this));
					HX_STACK_LINE(954)
					Float _g2;		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(954)
					{
					...
					HX_STACK_LINE(954)
					return ::Math_obj::sqrt((_g1 + (_g2 * _Function_2_2::Block(__this))));
				}
				return null();
			}
		};
...
::nape::geom::Vec2 Vec2_obj::normalise( ){
	...
	struct _Function_1_1{
		inline static Float Block( ::nape::geom::Vec2_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",992,0x020b6534)
			{
				HX_STACK_LINE(992)
				if ((__this->zpp_disp)){
					HX_STACK_LINE(992)
	...
	HX_STACK_LINE(996)
	{
		...
		struct _Function_2_1{
			inline static Float Block( ::nape::geom::Vec2_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",997,0x020b6534)
				{
					HX_STACK_LINE(997)
					if ((__this->zpp_disp)){
						HX_STACK_LINE(997)
		...
		HX_STACK_LINE(997)
		_g4 = (_g3 * _Function_2_1::Block(this));
		HX_STACK_LINE(997)
		Float _g5;		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(997)
		{
		...
		HX_STACK_LINE(997)
		d = (_g4 + (_g5 * _Function_2_2::Block(this)));
		HX_STACK_LINE(1006)
		...
		HX_STACK_LINE(1007)
		{
				...
				HX_STACK_LINE(1017)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",1017,0x020b6534)
							{
								HX_STACK_LINE(1017)
			...
			HX_STACK_LINE(1018)
			{
				...
				HX_STACK_LINE(1018)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 &_g){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",1018,0x020b6534)
							{
								HX_STACK_LINE(1018)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(1018)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		struct _Function_1_1{
			inline static Float Block( ::nape::geom::Vec2_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",1042,0x020b6534)
				{
					HX_STACK_LINE(1042)
					if ((__this->zpp_disp)){
						HX_STACK_LINE(1042)
		...
		struct _Function_1_2{
			inline static Float Block( ::nape::geom::Vec2_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",1046,0x020b6534)
				{
					HX_STACK_LINE(1046)
					Float _g3;		HX_STACK_VAR(_g3,"_g3");
					HX_STACK_LINE(1046)
					...
					HX_STACK_LINE(1046)
					_g4 = (_g3 * _Function_2_1::Block(__this));
					HX_STACK_LINE(1046)
					Float _g5;		HX_STACK_VAR(_g5,"_g5");
					HX_STACK_LINE(1046)
					{
					...
					HX_STACK_LINE(1046)
					x = (_g4 + (_g5 * _Function_2_2::Block(__this)));
					HX_STACK_LINE(1046)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		HX_STACK_LINE(1082)
		{
			...
			HX_STACK_LINE(1082)
			x = (_g + _Function_2_1::Block(vector));
			HX_STACK_LINE(1082)
			Float _g1;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(1082)
			{
			...
			HX_STACK_LINE(1082)
			y = (_g1 + _Function_2_2::Block(vector));
			HX_STACK_LINE(1082)
			if (((bool((x != x)) || bool((y != y))))){
				HX_STACK_LINE(1082)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 components cannot be NaN"));
			...
			if (((ret1->zpp_inner == null()))){
				...
				HX_STACK_LINE(1082)
				if ((!(((  (((_Function_3_1::Block(ret1) == x))) ? bool((_Function_3_2::Block(ret1) == y)) : bool(false) ))))){
					HX_STACK_LINE(1082)
					{
						HX_STACK_LINE(1082)
						ret1->zpp_inner->x = x;
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		HX_STACK_LINE(1135)
		{
			...
			HX_STACK_LINE(1135)
			x = (_g + (_Function_2_1::Block(vector) * scalar));
			HX_STACK_LINE(1135)
			Float _g1;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(1135)
			{
			...
			HX_STACK_LINE(1135)
			y = (_g1 + (_Function_2_2::Block(vector) * scalar));
			HX_STACK_LINE(1135)
			if (((bool((x != x)) || bool((y != y))))){
				HX_STACK_LINE(1135)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 components cannot be NaN"));
...
::nape::geom::Vec2 Vec2_obj::addeq( ::nape::geom::Vec2 vector){
	...
	HX_STACK_LINE(1254)
	{
		...
		HX_STACK_LINE(1254)
		if ((!(((  (((_Function_2_3::Block(this) == x))) ? bool((_Function_2_4::Block(this) == y)) : bool(false) ))))){
			HX_STACK_LINE(1254)
			{
				HX_STACK_LINE(1254)
				this->zpp_inner->x = x;
...
::nape::geom::Vec2 Vec2_obj::muleq( Float scalar){
	...
	HX_STACK_LINE(1340)
	if ((!(((  (((_Function_1_3::Block(this) == x))) ? bool((_Function_1_4::Block(this) == y)) : bool(false) ))))){
		HX_STACK_LINE(1340)
		{
			HX_STACK_LINE(1340)
			this->zpp_inner->x = x;
...
Float Vec2_obj::dot( ::nape::geom::Vec2 vector){
	...
	struct _Function_1_1{
		inline static Float Block( ::nape::geom::Vec2 &vector){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",1375,0x020b6534)
			{
				HX_STACK_LINE(1375)
				if (((bool((vector != null())) && bool(vector->zpp_disp)))){
					HX_STACK_LINE(1375)
	...
	HX_STACK_LINE(1375)
	_g1 = (_g * _Function_1_1::Block(vector));
	HX_STACK_LINE(1375)
	Float _g2;		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(1375)
	{
	...
	HX_STACK_LINE(1375)
	ret = (_g1 + (_g2 * _Function_1_2::Block(vector)));
	HX_STACK_LINE(1376)
	if ((vector->zpp_inner->weak)){
		HX_STACK_LINE(1380)
		{
...
Float Vec2_obj::cross( ::nape::geom::Vec2 vector){
	...
	struct _Function_1_1{
		inline static Float Block( ::nape::geom::Vec2_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",1435,0x020b6534)
			{
				HX_STACK_LINE(1435)
				if ((__this->zpp_disp)){
					HX_STACK_LINE(1435)
	...
	HX_STACK_LINE(1435)
	ret = (_g1 - (_g2 * _Function_1_2::Block(this)));
	HX_STACK_LINE(1436)
	if ((vector->zpp_inner->weak)){
		HX_STACK_LINE(1440)
		{
...
Float Vec2_obj::distance( ::nape::geom::Vec2 a,::nape::geom::Vec2 b){
	...
	struct _Function_1_1{
		inline static Float Block( ::nape::geom::Vec2 &b,::nape::geom::Vec2 &a){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",773,0x020b6534)
			{
				HX_STACK_LINE(773)
				Float ax;		HX_STACK_VAR(ax,"ax");
				HX_STACK_LINE(773)
