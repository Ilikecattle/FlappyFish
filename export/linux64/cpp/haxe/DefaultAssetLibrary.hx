...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/backgrounds.png", __ASSET__assets_images_backgrounds_png);
		type.set ("assets/images/backgrounds.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/pipes.png", __ASSET__assets_images_pipes_png);
		type.set ("assets/images/pipes.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		addExternal("assets/images/box.png", "image", "assets/images/box.png");
		addExternal("assets/images/backgrounds.png", "image", "assets/images/backgrounds.png");
		addExternal("assets/images/pipes.png", "image", "assets/images/pipes.png");
		addExternal("assets/images/ground.png", "image", "assets/images/ground.png");
...
@:keep class __ASSET__assets_images_box_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_backgrounds_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_pipes_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_ground_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep class __ASSET__flixel_flixel_ui_xml_default_popup_xml extends null { }
@:keep class __ASSET__flixel_flixel_ui_xml_defaults_xml extends null { }
